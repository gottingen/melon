...
set(MELON_C_OPTIONS ${CARBIN_CXX_OPTIONS})
list(REMOVE_ITEM MELON_C_OPTIONS "-Wclass-memaccess")
list(REMOVE_ITEM MELON_C_OPTIONS "-Wconversion-null")
set(MELON_CXX_OPTIONS ${CARBIN_CXX_OPTIONS})
...
if (CMAKE_SYSTEM_NAME STREQUAL "Darwin")
    ...
    list(APPEND MELON_CXX_OPTIONS "-Wno-deprecated-declarations" "-Wno-inconsistent-missing-override")
endif ()

if (WITH_DEBUG_SYMBOLS)
    set(DEBUG_SYMBOL "-g")
endif ()
list(APPEND MELON_CXX_DEFINES
        "-DNDEBUG"
        "-DFIBER_USE_FAST_PTHREAD_MUTEX"
...
list(APPEND MELON_CXX_OPTIONS -O2 -pipe -Wall -W -fstrict-aliasing -Wno-invalid-offsetof -Wno-unused-parameter -fno-omit-frame-pointer ${DEBUG_SYMBOL})
list(APPEND MELON_C_OPTIONS -O2 -pipe -Wall -W -fstrict-aliasing -Wno-unused-parameter -fno-omit-frame-pointer ${DEBUG_SYMBOL})
list(REMOVE_DUPLICATES MELON_CXX_OPTIONS)
list(REMOVE_DUPLICATES MELON_C_OPTIONS)
carbin_print_list_label("CXX_OPTIONS:" MELON_CXX_OPTIONS)
carbin_print_list_label("C_OPTIONS:" MELON_C_OPTIONS)

set(MELON_TEST_CXX_OPTIONS ${CARBIN_CXX_OPTIONS})
set(MELON_TEST_DEFINES "-DUNIT_TEST")
list(APPEND MELON_TEST_DEFINES
        "-DFIBER_USE_FAST_PTHREAD_MUTEX"
        "-D_GNU_SOURCE"
        "-DUSE_SYMBOLIZE"
        "-DNO_TCMALLOC"
...
list(APPEND MELON_TEST_CXX_OPTIONS
        "-fno-access-control"
        "-DMELON_VAR_NOT_LINK_DEFAULT_VARIABLES"
        "-D__STRICT_ANSI__"
        "-g"
        "-O2"
        "-pipe"
