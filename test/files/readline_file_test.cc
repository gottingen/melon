...
namespace melon {
    ...
    TEST(readlinefile, all) {
        ...
        }
        {
            ...
            auto rs = rl_file1.open(lines_file.fname(), melon::readline_option::eNoSkip);
            EXPECT_TRUE(rs.is_ok());
        ...
        {
            readline_file rl_file1;
            auto rs = rl_file1.open(lines_file.fname(), melon::readline_option::eTrimWhitespace);
            EXPECT_TRUE(rs.is_ok());
