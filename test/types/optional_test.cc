...
#define ABEL_GLIBCXX_OPTIONAL_TRIVIALITY_BUG 1
  ...
  EXPECT_TRUE(abel::is_trivially_copy_constructible<
              abel::optional<volatile int>>::value);
#endif  // _MSC_VER
...
#ifndef ABEL_GLIBCXX_OPTIONAL_TRIVIALITY_BUG
    EXPECT_TRUE(abel::is_trivially_copy_constructible<
                abel::optional<TrivialCopyable>>::value);
    EXPECT_TRUE(abel::is_trivially_copy_constructible<
                abel::optional<const TrivialCopyable>>::value);
#endif
...
#define ABEL_MSVC_OPTIONAL_VOLATILE_COPY_BUG 1
    ...
    EXPECT_FALSE(std::is_copy_constructible<
                 abel::optional<volatile TrivialCopyable>>::value);
#endif
  }
}
...
TEST(optionalTest, MoveConstructor) {
  ...
  EXPECT_TRUE(std::is_nothrow_move_constructible<
              abel::optional<MoveableNoThrow>>::value);
}
