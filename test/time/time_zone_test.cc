...
TEST(time_zone, Equality) {
  ...
  abel::time_zone la = abel::time_internal::load_time_zone("America/Los_Angeles");
  abel::time_zone nyc = abel::time_internal::load_time_zone("America/New_York");
  EXPECT_NE(la, nyc);
}
...
TEST(time_zone, NamedTimeZones) {
  ...
  abel::time_zone syd = abel::time_internal::load_time_zone("Australia/Sydney");
...
TEST(time_zone, Failures) {
  ...
  tz = abel::time_internal::load_time_zone("America/Los_Angeles");
  EXPECT_FALSE(load_time_zone("Invalid/time_zone", &tz));
  EXPECT_EQ(abel::utc_time_zone(), tz);  // guaranteed fallback to UTC
...
TEST(time_zone, local_time_zone) {
  ...
  abel::time_zone tz = abel::time_internal::load_time_zone("localtime");
