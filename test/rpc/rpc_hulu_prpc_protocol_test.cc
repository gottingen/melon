...
protected:
    ...
    void VerifyMessage(melon::rpc::InputMessageBase* msg) {
        ...
        msg->_arg = &_server;
        EXPECT_TRUE(melon::rpc::policy::VerifyHuluRequest(msg));
    }
...
TEST_F(HuluTest, process_response_after_eof) {
    ...
    ProcessMessage(melon::rpc::policy::ProcessHuluResponse, msg, true);
...
TEST_F(HuluTest, process_response_error_code) {
    ...
    melon::rpc::policy::MostCommonMessage* msg = MakeResponseMessage(meta);
    ProcessMessage(melon::rpc::policy::ProcessHuluResponse, msg, false);
...
TEST_F(HuluTest, hulu_compress) {
    TestHuluCompress(melon::rpc::COMPRESS_TYPE_SNAPPY);
    TestHuluCompress(melon::rpc::COMPRESS_TYPE_GZIP);
    TestHuluCompress(melon::rpc::COMPRESS_TYPE_ZLIB);
}
} //namespace
