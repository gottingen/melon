...
inline melon::rpc::Extension<const int>* ConstIntExtension() {
    return melon::rpc::Extension<const int>::instance();
}

inline melon::rpc::Extension<int>* IntExtension() {
    return melon::rpc::Extension<int>::instance();
}
