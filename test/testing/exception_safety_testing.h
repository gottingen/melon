...
// exceptions specifically thrown by ThrowingValue.
        class TestException {
        public:
            explicit TestException(abel::string_view msg) : msg_(msg) {}
...
// bad_alloc exception in TestExceptionSafety.
        ...
        public:
            explicit TestBadAllocException(abel::string_view msg) : TestException(msg) {}
...
// Sets the countdown to the terminal value -1
        ...
        void MaybeThrow(abel::string_view msg, bool throw_bad_alloc = false);
 ...
 */
    ...
    private:
        ...
        void ReadStateAndMaybeThrow(abel::string_view msg) const {
            if (!IsSpecified(AllocSpec::kNoThrowAllocate)) {
                exceptions_internal::MaybeThrow(
                        abel::Substitute("Allocator id $0 threw from $1", *dummy_, msg));
            }
        }
