...
namespace abel {
    ...
    namespace synchronization_internal {
        ...
        struct ThreadData {
            ...
            threading_internal::ThreadIdentity *identity1;  // First Post()-er.
            threading_internal::ThreadIdentity *identity2;  // First wait()-er.
...
// Need friendship with PerThreadSem.
        ...
        protected:
            static void Post(threading_internal::ThreadIdentity *id) {
