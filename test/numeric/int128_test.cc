...
TEST(Uint128, Hash) {
  EXPECT_TRUE(abel::VerifyTypeImplementsAbelHashCorrectly({
      ...
      ~abel::uint128{},
      // 64 bit limits
      abel::uint128{std::numeric_limits<int64_t>::max()},
      abel::uint128{std::numeric_limits<uint64_t>::max()} + 0,
      abel::uint128{std::numeric_limits<uint64_t>::max()} + 1,
      abel::uint128{std::numeric_limits<uint64_t>::max()} + 2,
      // Keeping high same
      abel::uint128{1} << 62,
      abel::uint128{1} << 63,
      // Keeping low same
...
TEST(Int128, DivisionAndModuloTest) {
  ...
  DivisionModCase manual_cases[] = {
      {abel::MakeInt128(0x6ada48d489007966, 0x3c9c5c98150d5d69),
       abel::MakeInt128(0x8bc308fb, 0x8cb9cc9a3b803344), 0xc3b87e08,
       abel::MakeInt128(0x1b7db5e1, 0xd9eca34b7af04b49)},
      {abel::MakeInt128(0xd6946511b5b, 0x4886c5c96546bf5f),
       -abel::MakeInt128(0x263b, 0xfd516279efcfe2dc), -0x59cbabf0,
       abel::MakeInt128(0x622, 0xf462909155651d1f)},
      {-abel::MakeInt128(0x33db734f9e8d1399, 0x8447ac92482bca4d), 0x37495078240,
       -abel::MakeInt128(0xf01f1, 0xbc0368bf9a77eae8), -0x21a508f404d},
      {-abel::MakeInt128(0x13f837b409a07e7d, 0x7fc8e248a7d73560), -0x1b9f,
       abel::MakeInt128(0xb9157556d724, 0xb14f635714d7563e), -0x1ade},
  };
