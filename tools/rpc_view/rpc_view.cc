...
static void handle_response(melon::rpc::Controller* client_cntl,
                            std::string target,
                            melon::rpc::Controller* server_cntl,
    ...
    if (client_cntl->Failed() &&
        client_cntl->ErrorCode() != melon::rpc::EHTTP) {
...
public:
    ...
    virtual void default_method(google::protobuf::RpcController* cntl_base,
        ...
        melon::rpc::Channel http_chan;
        melon::rpc::ChannelOptions http_chan_opt;
        http_chan_opt.protocol = melon::rpc::PROTOCOL_HTTP;
        if (http_chan.Init(target.c_str(), &http_chan_opt) != 0) {
            server_cntl->SetFailed(melon::rpc::EINTERNAL,
        ...
        melon::rpc::Controller* client_cntl = new melon::rpc::Controller;
        ...
        // Setup the URI.
        const melon::rpc::URI& server_uri = server_cntl->http_request().uri();
