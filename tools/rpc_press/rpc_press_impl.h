...
#ifndef PBRPCPRESS_PMELON_RPC_PRESS_H_
#define PBRPCPRESS_PMELON_RPC_PRESS_H_
...
namespace pbrpcframework {
    ...
    public:
        ...
        void call_method(melon::rpc::Controller *cntl,
                         google::protobuf::Message *request,
                         google::protobuf::Message *response,
                         google::protobuf::Closure *done);

    public:
        melon::rpc::Channel _rpc_client;
    ...
    private:
        ...
        void handle_response(melon::rpc::Controller *cntl,
                             google::protobuf::Message *request,
                             google::protobuf::Message *response,
        ...
        melon::LatencyRecorder _latency_recorder;
        melon::gauge<int64_t> _error_count;
        melon::gauge<int64_t> _sent_count;
        ...
        melon::rpc::InfoThread _info_thr;
    };
}
#endif // PBRPCPRESS_PMELON_RPC_PRESS_H_
