...
public:
    StreamingEchoService() : _sd(melon::rpc::INVALID_STREAM_ID) {};
    virtual ~StreamingEchoService() {
        melon::rpc::StreamClose(_sd);
    };
    virtual void Echo(google::protobuf::RpcController* controller,
        ...
        melon::rpc::Controller* cntl =
            static_cast<melon::rpc::Controller*>(controller);
        melon::rpc::StreamOptions stream_options;
        stream_options.handler = &_receiver;
        if (melon::rpc::StreamAccept(&_sd, *cntl, &stream_options) != 0) {
