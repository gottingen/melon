...
private:
    void process(const melon::RestfulRequest *request, melon::RestfulResponse *response) override {
        ...
        const std::string vue_src = "https://unpkg.com/vue@3/dist/vue.global.js";
        const std::string vue_src1 = "/js/vue";
  ...
  createApp({
    setup() {
      ...
      return {
        ...
        auto b = turbo::substitute(body, vue_src1, path);
        builder <<b<< "\n";

        response->set_body(builder.buf());
    }
};
}  // namespace myservice
