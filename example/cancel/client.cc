...
public:
    explicit CancelRPC(melon::rpc::CallId rpc_id) : _rpc_id(rpc_id) {}
    
    void Run() {
        melon::rpc::StartCancel(_rpc_id);
    }
    
private:
    melon::rpc::CallId _rpc_id;
};
...
int main(int argc, char* argv[]) {
    ...
    while (!melon::rpc::IsAskedToQuit()) {
        ...
        const melon::rpc::CallId id1 = cntl1.call_id();
        const melon::rpc::CallId id2 = cntl2.call_id();
        CancelRPC done1(id2);
        CancelRPC done2(id1);
