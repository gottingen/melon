...
#ifndef ABEL_CONTAINER_NODE_HASH_SET_H_
#define ABEL_CONTAINER_NODE_HASH_SET_H_
...
struct is_unordered_container<abel::node_hash_set<Key, Hash, KeyEqual, Allocator>>
        : std::true_type {
};
