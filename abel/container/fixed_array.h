...
#ifndef ABEL_CONTAINER_FIXED_ARRAY_H_
#define ABEL_CONTAINER_FIXED_ARRAY_H_
  ...
  private:
    ...
    class Storage : public InlinedStorage {
      ...
      private:
        ...
        // `compressed_tuple` takes advantage of EBCO for stateless `allocator_type`s
        container_internal::compressed_tuple <size_type, allocator_type> size_alloc_;
