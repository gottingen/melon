...
#ifndef ABEL_CONTAINER_INTERNAL_LAYOUT_H_
#define ABEL_CONTAINER_INTERNAL_LAYOUT_H_
...
class LayoutImpl<std::tuple<Elements...>, abel::index_sequence<SizeSeq...>,
  ...
  public:
    ...
    template<size_t N, enable_if_typr<N == 0> = 0>
    ...
    //
    // Requires: `p` is aligned to `Alignment()`.
    template<class Char, size_t N = NumOffsets - 1, enable_if_typr<N == 0> = 0>
