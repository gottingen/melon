...
#ifndef ABEL_BASE_THREAD_AFFINITY_H_
#define ABEL_BASE_THREAD_AFFINITY_H_
...
namespace abel {
    ...
    defined(__FreeBSD__)
        ...
        public:
            ...
            // anyOf() returns a affinity_policy that returns an core_affinity for a number of
            ...
            static std::shared_ptr <affinity_policy> any_of(
                    core_affinity &&affinity);

            // oneOf() returns a affinity_policy that returns an affinity with a single enabled
        ...
        core_affinity(const core_affinity &);
...
#endif  // ABEL_BASE_THREAD_AFFINITY_H_
