...
#ifndef ABEL_THREAD_THREAD_LOCAL_H_
#define ABEL_THREAD_THREAD_LOCAL_H_
...
#include "abel/thread/internal/always_initialized.h"
#include "abel/atomic/atomic_ptr.h"
...
namespace abel {
    ...
    public:
        ...
        T *get() const {
            ...
            return ABEL_LIKELY(!!ptr) ? ptr : get_slow();
        }
    ...
    private:
        ...
        mutable thread_internal::thread_local_always_initialized<abel::atomic_scoped_ptr<T>> raw_tls_;
        mutable std::mutex init_lock_;
        abel::function<std::unique_ptr<T>()> creator_;
    };

}  // namespace abel
#endif  // ABEL_THREAD_THREAD_LOCAL_H_
