...
// (they use abel::ascii_tolower instead of tolower).
//
...
#ifndef ABEL_STRINGS_INTERNAL_MEMUTIL_H_
#define ABEL_STRINGS_INTERNAL_MEMUTIL_H_
...
ABEL_FORCE_INLINE const char* memstr(const char* phaystack, size_t haylen,
                          const char* pneedle) {
  return int_memmatch<true>(phaystack, haylen, pneedle, strlen(pneedle));
}

ABEL_FORCE_INLINE const char* memcasestr(const char* phaystack, size_t haylen,
                              const char* pneedle) {
  return int_memmatch<false>(phaystack, haylen, pneedle, strlen(pneedle));
}

ABEL_FORCE_INLINE const char* memmem(const char* phaystack, size_t haylen,
                          const char* pneedle, size_t needlelen) {
  return int_memmatch<true>(phaystack, haylen, pneedle, needlelen);
}

ABEL_FORCE_INLINE const char* memcasemem(const char* phaystack, size_t haylen,
                              const char* pneedle, size_t needlelen) {
