...
// `std::string`, or another `abel::string_view` argument with no need to copy
// the string data. Systematic use of `string_view` within function arguments
// reduces data copies and `strlen()` calls.
//
// Because of its small size, prefer passing `string_view` by value:
//
//   void MyFunction(abel::string_view arg);
//
// If circumstances require, you may also pass one by const reference:
//
//   void MyFunction(const abel::string_view& arg);  // not preferred
//
...
//   abel::string_view sv = obj.ReturnAString();
//
//   // GOOD use of string_view: str outlives sv
//   std::string str = obj.ReturnAString();
//   abel::string_view sv = str;
//
...
// example, when splitting a string, `std::vector<abel::string_view>` is a
...
//   abel::string_view();
//   abel::string_view(nullcp, 0);
//   abel::string_view("");
//   abel::string_view("", 0);
//   abel::string_view("abcdef", 0);
//   abel::string_view("abcdef" + 6, 0);
//
// All empty `string_view` objects whether null or not, are equal:
//
//   abel::string_view() == abel::string_view("", 0)
//   abel::string_view(nullptr, 0) == abel::string_view("abcdef"+6, 0)
class string_view {
 public:
  ...
  // another `abel::string_view`, returning -1 if `this` is less than, 0 if
  ...
  // 'string_view` and another `abel::string_view`.
  int compare(size_type pos1, size_type count1, string_view v) const {
    return substr(pos1, count1).compare(v);
  }

  // Overload of `string_view::compare()` for comparing a substring of the
  // `string_view` and a substring of another `abel::string_view`.
...
ABEL_FORCE_INLINE string_view ClippedSubstr(string_view s, size_t pos,
...
// NullSafeStringView()
//
// Creates an `abel::string_view` from a pointer `p` even if it's null-valued.
// This function should be used where an `abel::string_view` can be created from
