...
// state.
    ...
    ABEL_MUST_USE_RESULT bool simple_atoi(abel::string_view str, int_type *out);
...
// returns `false`, leaving `out` in an unspecified state.
    ABEL_MUST_USE_RESULT bool simple_atof(abel::string_view str, float *out);
...
// always use the "C" locale. If any errors are encountered, this function
// returns `false`, leaving `out` in an unspecified state.
    ABEL_MUST_USE_RESULT bool simple_atod(abel::string_view str, double *out);
...
// safe_strto?() functions for implementing simple_atoi()
        ...
        bool safe_strtou128_base(abel::string_view text, abel::uint128 *value,
                                 int base);
...
// with base different from 10 elsewhere in abel implementation).
        template<typename int_type>
        ABEL_MUST_USE_RESULT bool safe_strtoi_base(abel::string_view s, int_type *out,
                                                   int base) {
...
// integer type.
    ...
    ABEL_MUST_USE_RESULT ABEL_FORCE_INLINE bool simple_atoi(abel::string_view str,
                                                            abel::uint128 *out) {
