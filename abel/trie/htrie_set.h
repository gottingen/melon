...
#ifndef ABEL_TRIE_HTRIE_SET_H_
#define ABEL_TRIE_HTRIE_SET_H_
...
class htrie_set {
  private:
    ...
    using ht = abel::detail_htrie_hash::htrie_hash<CharT, void, Hash, KeySizeT>;
