...
#ifndef ABEL_TRIE_INTERNAL_ARRAY_MAP_H_
#define ABEL_TRIE_INTERNAL_ARRAY_MAP_H_
...
#include <type_traits>
#include <utility>
#include "abel/trie/internal/array_hash.h"
 ...
 */
template<class CharT, class T, class Hash = abel::trie_internal::str_hash<CharT>,
...
class array_map {
  private:
    ...
    using ht = abel::detail_array_hash::array_hash<CharT, T, Hash, KeyEqual,
...
/**
 * Same as
 * `abel::array_map<CharT, T, Hash, KeyEqual, StoreNullTerminator, KeySizeT,
 * IndexSizeT, abel::ah::prime_growth_policy>`.
 */
template<class CharT, class T, class Hash = abel::trie_internal::str_hash<CharT>,
        class KeyEqual = abel::trie_internal::str_equal<CharT>,
        bool StoreNullTerminator = true, class KeySizeT = std::uint16_t,
...
#endif  // ABEL_TRIE_INTERNAL_ARRAY_MAP_H_
