...
#include <abel/asl/algo/container.h>
#include <abel/asl/container/container_memory.h>
#include <abel/asl/container/hash_function_defaults.h>  // IWYU pragma: export
#include <abel/asl/container/raw_hash_map.h>  // IWYU pragma: export
...
// Erases all elements that satisfy the predicate `pred` from the container `c`.
    ...
    typedef flat_hash_map<std::string, std::string, abel::container_internal::case_string_hash,
            abel::container_internal::case_string_equal> ignore_case_flat_hash_map;
