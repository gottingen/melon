...
#ifndef ABEL_BASE_DYNAMIC_ANNOTATIONS_H_
#define ABEL_BASE_DYNAMIC_ANNOTATIONS_H_
...
static ABEL_FORCE_INLINE void StaticAnnotateIgnoreReadsBegin(const char *file, int line)
    ATTRIBUTE_IGNORE_READS_BEGIN { (void)file; (void)line; }
static ABEL_FORCE_INLINE void StaticAnnotateIgnoreReadsEnd(const char *file, int line)
    ATTRIBUTE_IGNORE_READS_END { (void)file; (void)line; }
static ABEL_FORCE_INLINE void StaticAnnotateIgnoreWritesBegin(
    const char *file, int line) { (void)file; (void)line; }
static ABEL_FORCE_INLINE void StaticAnnotateIgnoreWritesEnd(
    const char *file, int line) { (void)file; (void)line; }
...
template <typename T>
ABEL_FORCE_INLINE T ANNOTATE_UNPROTECTED_READ(const volatile T &x) { /* NOLINT */
  ANNOTATE_IGNORE_READS_BEGIN();
  T res = x;
  ANNOTATE_IGNORE_READS_END();
  return res;
...
#endif  /* ABEL_BASE_DYNAMIC_ANNOTATIONS_H_ */
