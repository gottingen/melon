...
//! ror32 - generic implementation
    static ABEL_FORCE_INLINE uint32_t ror32_generic(const uint32_t &x, int i) {
...
//! ror32 - gcc/clang assembler
    static ABEL_FORCE_INLINE uint32_t ror32(const uint32_t &x, int i) {
        uint32_t x1 = x;
...
//! ror64 - generic implementation
    static ABEL_FORCE_INLINE uint64_t ror64_generic(const uint64_t &x, int i) {
...
//! ror64 - gcc/clang assembler
    static ABEL_FORCE_INLINE uint64_t ror64(const uint64_t &x, int i) {
        uint64_t x1 = x;
