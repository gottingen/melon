...
// ABEL_INTERNAL_LOG and ABEL_INTERNAL_CHECK work like the RAW variants above,
...
// string_cat if you need to build a richer message.
#define ABEL_INTERNAL_LOG(severity, message)                                \
  do {                                                                      \
    ::abel::raw_logging_internal::internal_log_function(                    \
        ABEL_RAW_LOGGING_INTERNAL_##severity, __FILE__, __LINE__, message); \
  } while (0)
...
#define ABEL_RAW_LOGGING_INTERNAL_INFO ::abel::LogSeverity::kInfo
#define ABEL_RAW_LOGGING_INTERNAL_WARNING ::abel::LogSeverity::kWarning
#define ABEL_RAW_LOGGING_INTERNAL_ERROR ::abel::LogSeverity::kError
#define ABEL_RAW_LOGGING_INTERNAL_FATAL ::abel::LogSeverity::kFatal
#define ABEL_RAW_LOGGING_INTERNAL_LEVEL(severity) \
...
// 'file' and 'line' are the file and line number where the ABEL_RAW_LOG macro
// was located.
