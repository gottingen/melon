...
// size of 8192 items and single thread.
        ...
        struct async_factory_impl {
            ...
            static std::shared_ptr<async_logger> create(const std::string &logger_name, SinkArgs &&... args) {
                ...
                auto new_logger = std::make_shared<async_logger>(logger_name, std::move(sink), std::move(tp),
                                                                 OverflowPolicy);
        ...
        template<typename Sink, typename... SinkArgs>
        inline std::shared_ptr<abel::log::logger>
        ...
        template<typename Sink, typename... SinkArgs>
        inline std::shared_ptr<abel::log::logger>
        create_async_nb(const std::string &logger_name, SinkArgs &&... sink_args) {
