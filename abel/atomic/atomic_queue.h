...
ABEL_DISABLE_GCC_WARNING(-Wconversion)
...
namespace abel {namespace  atomic_internal {
...
// otherwise.
    struct atomic_queue_default_traits {
        ...
        static const size_t MAX_SUBQUEUE_SIZE = atomic_internal::const_numeric_max<size_t>::value;
...
#pragma warning(pop)
        ...
        static inline auto deref_noexcept(It &it) ABEL_NOEXCEPT -> decltype(*it) {
            return *it;
        }
...
#pragma warning(disable: 4309)		// static_cast: Truncation of constant value
        ...
        static const size_t MAX_SUBQUEUE_SIZE = (atomic_internal::const_numeric_max<size_t>::value -
                                                ...
                                                ? atomic_internal::const_numeric_max<size_t>::value : (
...
#pragma warning(pop)
    ...
    private:
        atomic_queue &swap_internal(atomic_queue &other) {
            ...
            atomic_internal::swap_relaxed(producerListTail, other.producerListTail);
            atomic_internal::swap_relaxed(producerCount, other.producerCount);
            atomic_internal::swap_relaxed(initialBlockPoolIndex, other.initialBlockPoolIndex);
            std::swap(initialBlockPool, other.initialBlockPool);
            std::swap(initialBlockPoolSize, other.initialBlockPoolSize);
            freeList.swap(other.freeList);
            atomic_internal::swap_relaxed(nextExplicitConsumerId, other.nextExplicitConsumerId);
            atomic_internal::swap_relaxed(globalExplicitConsumerOffset, other.globalExplicitConsumerOffset);
    ...
    public:
        ...
        inline bool enqueue(T const &item) {
            ABEL_CONSTEXPR_IF (INITIAL_IMPLICIT_PRODUCER_HASH_SIZE == 0) return false;
        ...
        bool try_dequeue(U &item) {
            ...
            if (nonEmptyCount > 0) {
                if (ABEL_LIKELY(best->dequeue(item))) {
                    return true;
                }
                for (auto ptr = producerListTail.load(std::memory_order_acquire);
        ...
        static bool is_lock_free() {
            return
                    atomic_internal::static_is_lock_free<bool>::value == 2 &&
                    atomic_internal::static_is_lock_free<size_t>::value == 2 &&
                    atomic_internal::static_is_lock_free<std::uint32_t>::value == 2 &&
                    atomic_internal::static_is_lock_free<index_t>::value == 2 &&
                    atomic_internal::static_is_lock_free<void *>::value == 2 &&
                    atomic_internal::static_is_lock_free<typename atomic_internal::thread_id_converter<atomic_internal::thread_id_t>::thread_id_numeric_size_t>::value ==
                    2;
        }
    ...
    private:
        ...
        inline bool update_current_producer_after_rotation(consumer_token_t &token) {
            ...
            if (ABEL_UNLIKELY(token.desiredProducer == nullptr)) {
        ...
        struct FreeList {
            ...
            void swap(FreeList &other) { atomic_internal::swap_relaxed(freeListHead, other.freeListHead); }

            FreeList(FreeList const &) ABEL_FUNCTION_DELETE;

            FreeList &operator=(FreeList const &) ABEL_FUNCTION_DELETE;
...
private:
        ...
        struct producer_base : public atomic_internal::atomic_queue_producer_type_less_base {
            ...
            inline size_t size_approx() const {
                ...
                return atomic_internal::circular_less_than(head, tail) ? static_cast<size_t>(tail - head) : 0;
            }
        ...
        struct explicit_producer : public producer_base {
            explicit explicit_producer(atomic_queue *parent_) :
                ...
                size_t poolBasedIndexSize = atomic_internal::ceil_to_pow_2(parent_->initialBlockPoolSize) >> 1;
            ...
            inline bool enqueue(U &&element) {
                ...
                if ((currentTailIndex & static_cast<index_t>(BLOCK_SIZE - 1)) == 0) {
                    ...
                    if (this->tailBlock != nullptr &&
                        ...
                        if (!atomic_internal::circular_less_than<index_t>(head, currentTailIndex + BLOCK_SIZE)
            ...
            bool dequeue(U &element) {
                ...
                if (atomic_internal::circular_less_than<index_t>(
                    ...
                    if (ABEL_LIKELY(atomic_internal::circular_less_than<index_t>(myDequeueCount - overcommit, tail))) {
            ...
            bool enqueue_bulk(It itemFirst, size_t count) {
                ...
                if (blockBaseDiff > 0) {
                    ...
                    if (ABEL_NOEXCEPT_EXPR(new((T *) nullptr) T(atomic_internal::deref_noexcept(itemFirst)))) {
                ...
                while (true) {
                    ...
                    if (atomic_internal::circular_less_than<index_t>(newTailIndex, stopIndex)) {
                    ...
                    if (ABEL_NOEXCEPT_EXPR(new((T *) nullptr) T(atomic_internal::deref_noexcept(itemFirst)))) {
                        ...
                        ABEL_TRY {
                            ...
                            if (!atomic_internal::is_trivially_destructible<T>::value) {
                                ...
                                while (true) {
                                    stopIndex = (currentTailIndex & ~static_cast<index_t>(BLOCK_SIZE - 1)) +
                                                static_cast<index_t>(BLOCK_SIZE);
                                    if (atomic_internal::circular_less_than<index_t>(constructedStopIndex, stopIndex)) {
            ...
            size_t dequeue_bulk(It &itemFirst, size_t max) {
                ...
                auto desiredCount = static_cast<size_t>(tail -
                                                        (this->dequeueOptimisticCount.load(std::memory_order_relaxed) -
                                                         overcommit));
                if (atomic_internal::circular_less_than<size_t>(0, desiredCount)) {
                    ...
                    if (atomic_internal::circular_less_than<size_t>(0, actualCount)) {
                        ...
                        do {
                            ...
                            endIndex = atomic_internal::circular_less_than<index_t>(
        ...
        private:
            ...
            bool new_block_index(size_t numberOfFilledSlotsToExpose) {
                ...
                auto newBlockIndexEntries = reinterpret_cast<BlockIndexEntry *>(atomic_internal::align_for<BlockIndexEntry>(
                ...
                if (atomic_internal::circular_less_than<size_t>(0, desiredCount)) {
                    ...
                    if (atomic_internal::circular_less_than<size_t>(0, actualCount)) {
                        ...
                        do {
                            ...
                            auto block = entry->value.load(std::memory_order_relaxed);
                            if (ABEL_NOEXCEPT_EXPR(atomic_internal::deref_noexcept(itemFirst) = std::move(
                                    (*(*block)[index])))) {
                                while (index != endIndex) {
                                    auto &el = *((*block)[index]);
                                    *itemFirst++ = std::move(el);
        ...
        private:
            ...
            bool new_block_index() {
                ...
                auto entries = reinterpret_cast<BlockIndexEntry *>(atomic_internal::align_for<BlockIndexEntry>(
                        raw + sizeof(BlockIndexHeader)));
                auto index = reinterpret_cast<BlockIndexEntry **>(atomic_internal::align_for<BlockIndexEntry *>(
            ...
            static MemStats getFor(atomic_queue* q)
            {
                ...
                for (auto ptr = q->producerListTail.load(std::memory_order_acquire); ptr != nullptr; ptr = ptr->next_prod()) {
                    ...
                    if (implicit) {
                        ...
                        for (; atomic_internal::circular_less_than<index_t>(head, tail); head += BLOCK_SIZE) {
    ...
    private:
        ...
        inline void populate_initial_implicit_producer_hash() {
            ABEL_CONSTEXPR_IF (INITIAL_IMPLICIT_PRODUCER_HASH_SIZE == 0) {
                ...
                for (size_t i = 0; i != INITIAL_IMPLICIT_PRODUCER_HASH_SIZE; ++i) {
                    initialImplicitProducerHashEntries[i].key.store(atomic_internal::invalid_thread_id,
                                                                    std::memory_order_relaxed);
                }
                hash->prev = nullptr;
        ...
        void swap_implicit_producer_hashes(atomic_queue &other) {
            ABEL_CONSTEXPR_IF (INITIAL_IMPLICIT_PRODUCER_HASH_SIZE == 0) {
                ...
                atomic_internal::swap_relaxed(implicitProducerHashCount, other.implicitProducerHashCount);

                atomic_internal::swap_relaxed(implicitProducerHash, other.implicitProducerHash);
        ...
        ImplicitProducer *get_or_add_implicit_producer() {
            ...
            for (auto hash = mainHash; hash != nullptr; hash = hash->prev) {
                ...
                while (true) {        // Not an infinite loop because at least one slot is free in the hash table
                    ...
                    if (probedKey == atomic_internal::invalid_thread_id) {
        ...
        static inline void *aligned_malloc(size_t size) {
            if (std::alignment_of<TAlign>::value <= std::alignment_of<atomic_internal::max_align_t>::value)
                return (Traits::malloc)(size);
            size_t alignment = std::alignment_of<TAlign>::value;
            void *raw = (Traits::malloc)(size + alignment - 1 + sizeof(void *));
            if (!raw)
                return nullptr;
            char *ptr = atomic_internal::align_for<TAlign>(reinterpret_cast<char *>(raw) + sizeof(void *));
...
#endif //ABEL_ATOMIC_ATOMIC_QUEUE_H_
