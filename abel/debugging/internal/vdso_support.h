...
#ifndef ABEL_DEBUGGING_INTERNAL_VDSO_SUPPORT_H_
#define ABEL_DEBUGGING_INTERNAL_VDSO_SUPPORT_H_
...
#ifdef ABEL_HAVE_VDSO_SUPPORT
#error ABEL_HAVE_VDSO_SUPPORT cannot be directly set
#else
#define ABEL_HAVE_VDSO_SUPPORT 1
#endif
...
class VDSOSupport {
 ...
 private:
  ...
  ABEL_CONST_INIT static std::atomic<GetCpuFn> getcpu_fn_;
...
#endif  // ABEL_DEBUGGING_INTERNAL_VDSO_SUPPORT_H_
