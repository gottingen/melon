...
#ifndef ABEL_CHRONO_INTERNAL_TIME_ZONE_H_
#define ABEL_CHRONO_INTERNAL_TIME_ZONE_H_
...
using sys_seconds = seconds;  // Deprecated.  Use abel::chrono_internal::seconds instead.

namespace detail {
template<typename D>
ABEL_FORCE_INLINE std::pair<time_point<seconds>, D> split_seconds(const time_point<D> &tp) {
...
ABEL_FORCE_INLINE std::pair<time_point<seconds>, seconds> split_seconds(const time_point<seconds> &tp) {
...
//
// Example:
//   abel::chrono_internal::time_zone utc = abel::chrono_internal::utc_time_zone();
//   abel::chrono_internal::time_zone pst = abel::chrono_internal::fixed_time_zone(std::chrono::hours(-8));
//   abel::chrono_internal::time_zone loc = abel::chrono_internal::local_time_zone();
//   abel::chrono_internal::time_zone lax;
//   if (!abel::chrono_internal::load_time_zone("America/Los_Angeles", &lax)) { ... }
//
// See also:
...
public:
    ...
    // An absolute_lookup represents the civil time (abel::chrono_internal::civil_second) within
    ...
    //   const abel::chrono_internal::time_zone::absolute_lookup al = tz.lookup(tp);
    struct absolute_lookup {
        ...
        // indirectly by way of abel::chrono_internal::format().
    ...
    // correspond to the given civil time (abel::chrono_internal::civil_second) within this
    ...
    //
    //   // A unique civil time.
    //   auto jan01 = lax.lookup(abel::chrono_internal::civil_second(2011, 1, 1, 0, 0, 0));
    //   // jan01.kind == abel::chrono_internal::time_zone::civil_lookup::UNIQUE
    //   // jan01.pre    is 2011/01/01 00:00:00 -0800
    //   // jan01.trans  is 2011/01/01 00:00:00 -0800
    //   // jan01.post   is 2011/01/01 00:00:00 -0800
    //
    //   // A Spring DST transition, when there is a gap in civil time.
    //   auto mar13 = lax.lookup(abel::chrono_internal::civil_second(2011, 3, 13, 2, 15, 0));
    //   // mar13.kind == abel::chrono_internal::time_zone::civil_lookup::SKIPPED
    //   // mar13.pre   is 2011/03/13 03:15:00 -0700
    //   // mar13.trans is 2011/03/13 03:00:00 -0700
    //   // mar13.post  is 2011/03/13 01:15:00 -0800
    //
    //   // A Fall DST transition, when civil times are repeated.
    //   auto nov06 = lax.lookup(abel::chrono_internal::civil_second(2011, 11, 6, 1, 15, 0));
    //   // nov06.kind == abel::chrono_internal::time_zone::civil_lookup::REPEATED
    ...
    //
    // Example:
    //   abel::chrono_internal::time_zone nyc;
    //   if (!abel::chrono_internal::load_time_zone("America/New_York", &nyc)) { ... }
    //   const auto now = std::chrono::system_clock::now();
    //   auto tp = abel::chrono_internal::time_point<abel::chrono_internal::seconds>::min();
    //   abel::chrono_internal::time_zone::civil_transition trans;
...
// Returns the civil time (abel::chrono_internal::civil_second) within the given time zone at
// the given absolute time (time_point). Since the additional fields provided
// by the time_zone::absolute_lookup struct should rarely be needed in modern
// code, this convert() function is simpler and should be preferred.
template<typename D>
ABEL_FORCE_INLINE civil_second convert(const time_point<D> &tp, const time_zone &tz) {
...
ABEL_FORCE_INLINE time_point<seconds> convert(const civil_second &cs,
                                              const time_zone &tz) {
...
// Formats the given time_point in the given abel::chrono_internal::time_zone according to
...
//   abel::chrono_internal::time_zone lax;
//   if (!abel::chrono_internal::load_time_zone("America/Los_Angeles", &lax)) { ... }
//   auto tp = abel::chrono_internal::convert(abel::chrono_internal::civil_second(2013, 1, 2, 3, 4, 5), lax);
//   std::string f = abel::chrono_internal::format("%H:%M:%S", tp, lax);  // "03:04:05"
//   f = abel::chrono_internal::format("%H:%M:%E3S", tp, lax);            // "03:04:05.000"
template<typename D>
...
// options, with the same extensions as abel::chrono_internal::format(), but with the
...
// than normalizing them like abel::chrono_internal::civil_second() would do. For example, it
...
//   if (abel::chrono_internal::parse("%Y-%m-%d", "2015-10-09", tz, &tp)) {
//     ...
//   }
template<typename D>
ABEL_FORCE_INLINE bool parse(const std::string &fmt, const std::string &input,
...
#endif  // ABEL_CHRONO_INTERNAL_TIME_ZONE_H_
