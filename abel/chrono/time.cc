...
ABEL_FORCE_INLINE int MapWeekday (const abel::chrono_internal::weekday &wd) {
    switch (wd) {
    case abel::chrono_internal::weekday::monday:return 1;
    case abel::chrono_internal::weekday::tuesday:return 2;
    case abel::chrono_internal::weekday::wednesday:return 3;
    case abel::chrono_internal::weekday::thursday:return 4;
    case abel::chrono_internal::weekday::friday:return 5;
    case abel::chrono_internal::weekday::saturday:return 6;
    case abel::chrono_internal::weekday::sunday:return 7;
    }
    return 1;
}
...
abel::time_zone::time_info time_zone::at (chrono_second ct) const {
    ...
    switch (cl.kind) {
    case abel::chrono_internal::time_zone::civil_lookup::UNIQUE:ti.kind = time_zone::time_info::UNIQUE;
        break;
    case abel::chrono_internal::time_zone::civil_lookup::SKIPPED:ti.kind = time_zone::time_info::SKIPPED;
        break;
    case abel::chrono_internal::time_zone::civil_lookup::REPEATED:ti.kind = time_zone::time_info::REPEATED;
        break;
    }
...
abel::time_conversion convert_date_time (int64_t year, int mon, int day, int hour,
    ...
    tc.post = ti.post;
    switch (ti.kind) {
    case time_zone::time_info::UNIQUE:tc.kind = time_conversion::UNIQUE;
        break;
    case time_zone::time_info::SKIPPED:tc.kind = time_conversion::SKIPPED;
        break;
    case time_zone::time_info::REPEATED:tc.kind = time_conversion::REPEATED;
        break;
    }
    tc.normalized = false;
...
struct tm to_tm (abel::abel_time t, abel::time_zone tz) {
    ...
    case chrono_weekday::sunday:tm.tm_wday = 0;
        break;
    case chrono_weekday::monday:tm.tm_wday = 1;
        break;
    case chrono_weekday::tuesday:tm.tm_wday = 2;
        break;
    case chrono_weekday::wednesday:tm.tm_wday = 3;
        break;
    case chrono_weekday::thursday:tm.tm_wday = 4;
        break;
    case chrono_weekday::friday:tm.tm_wday = 5;
        break;
    case chrono_weekday::saturday:tm.tm_wday = 6;
        break;
    }
