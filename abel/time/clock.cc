...
abel_time now() {
  ...
  if (n >= 0) {
    return time_internal::from_unix_duration(
...
#include <abel/time/internal/get_current_time_chrono.inc>
#else
#include <abel/time/internal/get_current_time_posix.inc>
#endif

// Allows override by test.
#ifndef GET_CURRENT_TIME_NANOS_FROM_SYSTEM
#define GET_CURRENT_TIME_NANOS_FROM_SYSTEM() \
  ::abel::time_internal::GetCurrentTimeNanosFromSystem()
#endif
