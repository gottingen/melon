...
#ifndef ABEL_UTILITY_INTERNAL_INLINE_VARIABLE_EMULATION_H_
#define ABEL_UTILITY_INTERNAL_INLINE_VARIABLE_EMULATION_H_
...
#define ABEL_INTERNAL_EXTERN_DECL(type, name) \
  extern const ::abel::identity_t<type> name;
...
#define ABEL_INTERNAL_INLINE_CONSTEXPR(type, name, init) \
  ...
  inline constexpr ::abel::identity_t<type> name = init
...
#endif  // ABEL_UTILITY_INTERNAL_INLINE_VARIABLE_EMULATION_H_
