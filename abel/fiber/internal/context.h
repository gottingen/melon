...
intptr_t LIBCONTEXT_CALL_CONVENTION fiber_jump_context(fcontext_t *ofc, fcontext_t nfc,
                                                       intptr_t vp, bool preserve_fpu = false);
fcontext_t LIBCONTEXT_CALL_CONVENTION fiber_make_context(void *sp, size_t size, void (*fn)(intptr_t));
