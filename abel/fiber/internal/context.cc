...
".text\n"
".p2align 4,,15\n"
".globl	_fiber_jump_context\n"
".def	_fiber_jump_context;	.scl	2;	.type	32;	.endef\n"
"_fiber_jump_context:\n"
"    mov    0x10(%esp),%ecx\n"
"    push   %ebp\n"
"    push   %ebx\n"
...
".def	_fiber_make_context;	.scl	2;	.type	32;	.endef\n"
"_fiber_make_context:\n"
"mov    0x4(%esp),%eax\n"
"lea    -0x8(%eax),%eax\n"
"and    $0xfffffff0,%eax\n"
...
".text\n"
".p2align 4,,15\n"
".globl	fiber_jump_context\n"
".def	fiber_jump_context;	.scl	2;	.type	32;	.endef\n"
".seh_proc	fiber_jump_context\n"
"fiber_jump_context:\n"
".seh_endprologue\n"
"	push   %rbp\n"
"	push   %rbx\n"
...
".def	fiber_make_context;	.scl	2;	.type	32;	.endef\n"
".seh_proc	fiber_make_context\n"
"fiber_make_context:\n"
".seh_endprologue\n"
"mov    %rcx,%rax\n"
"sub    $0x28,%rax\n"
...
".globl fiber_jump_context\n"
".align 2\n"
".type fiber_jump_context,@function\n"
"fiber_jump_context:\n"
"    movl  0x10(%esp), %ecx\n"
"    pushl  %ebp  \n"
"    pushl  %ebx  \n"
...
"    movl  %eax, 0x4(%esp)\n"
"    jmp  *%edx\n"
".size fiber_jump_context,.-fiber_jump_context\n"
...
".globl fiber_make_context\n"
".align 2\n"
".type fiber_make_context,@function\n"
"fiber_make_context:\n"
"    movl  0x4(%esp), %eax\n"
"    leal  -0x8(%eax), %eax\n"
"    andl  $-16, %eax\n"
...
"    call  _exit@PLT\n"
"    hlt\n"
".size fiber_make_context,.-fiber_make_context\n"
".section .note.GNU-stack,\"\",%progbits\n"
);
...
"    sub  a1, a1, #104\n"
"    @ third arg of fiber_make_context() == address of context-function\n"
"    str  a3, [a1,#100]\n"
