...
static struct MutexGlobals {
  MutexGlobals() {
    ...
    num_cpus = abel::base_internal::NumCPUs();
...
ABEL_XRAY_LOG_ARGS(1) void mutex::Block(PerThreadSynch *s) {
...
ABEL_XRAY_LOG_ARGS(1) void mutex::lock() {
...
ABEL_XRAY_LOG_ARGS(1) void mutex::reader_lock() {
...
ABEL_XRAY_LOG_ARGS(1) bool mutex::try_lock() {
...
ABEL_XRAY_LOG_ARGS(1) bool mutex::reader_try_lock() {
...
ABEL_XRAY_LOG_ARGS(1) void mutex::unlock() {
...
ABEL_XRAY_LOG_ARGS(1) void mutex::reader_unlock() {
