...
#ifndef MELON_THREAD_AFFINITY_H_
#define MELON_THREAD_AFFINITY_H_
...
namespace melon {
    ...
    struct core_affinity {
        // supported is true if melon supports controlling thread affinity for this
        // platform.
...
#endif  // MELON_THREAD_AFFINITY_H_
