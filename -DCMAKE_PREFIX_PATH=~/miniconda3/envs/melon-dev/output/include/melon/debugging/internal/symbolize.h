...
// This file contains internal parts of the melon symbolizer.
// Do not depend on the anything in this file, it may change at anytime.

#ifndef MELON_DEBUGGING_INTERNAL_SYMBOLIZE_H_
#define MELON_DEBUGGING_INTERNAL_SYMBOLIZE_H_
...
#error MELON_INTERNAL_HAVE_ELF_SYMBOLIZE cannot be directly set
#elif defined(__ELF__) && defined(__GLIBC__) && !defined(__native_client__) && \
    !defined(__asmjs__) && !defined(__wasm__)
#define MELON_INTERNAL_HAVE_ELF_SYMBOLIZE 1
...
#endif  // MELON_INTERNAL_HAVE_ELF_SYMBOLIZE
...
#endif  // MELON_DEBUGGING_INTERNAL_SYMBOLIZE_H_
