...
namespace melon {
    ...
    public:
        ...
        raw_packer &pack32(uint32_t host_value) {
            *(uint32_t *) _stream = melon::base::melon_hton32(host_value);
            _stream += 4;
            return *this;
        }
        ...
        raw_packer &pack64(uint64_t host_value) {
            ...
            p[0] = melon::base::melon_hton32(host_value >> 32);
            p[1] = melon::base::melon_hton32(host_value & 0xFFFFFFFF);
            _stream += 8;
            return *this;
        }
    ...
    public:
        ...
        raw_unpacker &unpack32(uint32_t &host_value) {
            host_value = melon::base::melon_ntoh32(*(const uint32_t *) _stream);
            _stream += 4;
            return *this;
        }
        ...
        raw_unpacker &unpack64(uint64_t &host_value) {
            ...
            host_value = (((uint64_t) melon::base::melon_ntoh32(p[0])) << 32) | melon::base::melon_ntoh32(p[1]);
            _stream += 8;
            return *this;
        }
