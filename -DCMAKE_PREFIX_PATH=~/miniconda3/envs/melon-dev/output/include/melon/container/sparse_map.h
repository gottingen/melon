...
#ifndef  MELON_CONTAINER_SPARSE_MAP_H_
#define  MELON_CONTAINER_SPARSE_MAP_H_
...
#include "melon/container/sparse_hash.h"
 ...
 * `melon::sh::power_of_two_growth_policy`. This policy keeps the number of
 ...
 * your own growth policy, check `melon::sh::power_of_two_growth_policy` for the
 * interface.
 *
 ...
 * `melon::sh::exception_safety::strong`, the drawback is that the map will be
 ...
 * `melon::sh::sparsity::medium` sparsity offers a good compromise. It doesn't
 ...
 */
    template<class Key, class T, class Hash = std::hash<Key>,
            ...
            class GrowthPolicy = melon::sh::power_of_two_growth_policy<2>,
            melon::sh::exception_safety ExceptionSafety =
            melon::sh::exception_safety::basic,
            melon::sh::sparsity Sparsity = melon::sh::sparsity::medium>
    class sparse_map {
    private:
        template<typename U>
        using has_is_transparent = melon::detail_sparse_hash::has_is_transparent<U>;
        ...
        using ht = detail_sparse_hash::sparse_hash<
                ...
                GrowthPolicy, ExceptionSafety, Sparsity, melon::sh::probing::quadratic>;
    ...
    /**
     * Same as `melon::sparse_map<Key, T, Hash, KeyEqual, Allocator,
     * melon::sh::prime_growth_policy>`.
     */
    template<class Key, class T, class Hash = std::hash<Key>,
            class KeyEqual = std::equal_to<Key>,
            class Allocator = std::allocator<std::pair<Key, T>>>
    using sparse_pg_map =
    sparse_map<Key, T, Hash, KeyEqual, Allocator, melon::sh::prime_growth_policy>;

}  // namespace melon

#endif  // MELON_CONTAINER_SPARSE_MAP_H_
