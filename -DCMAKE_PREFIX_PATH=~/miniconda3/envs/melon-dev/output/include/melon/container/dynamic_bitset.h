...
#ifndef MELON_CONTAINER_DYNAMIC_BITSET_H_
#define MELON_CONTAINER_DYNAMIC_BITSET_H_
...
//=================================================================================================
    ...
    block_count(const block_type &block) noexcept {
        return static_cast<size_type>(melon::base::popcount(block));
    }
    ...
    block_count(const block_type &block, size_type nbits) noexcept {
        ...
        return static_cast<size_type>(melon::base::popcount(shifted_block));
    }
    ...
    count_block_trailing_zero(const block_type &block) noexcept {
        ...
        return static_cast<size_type>(melon::base::countr_zero(block));
    }
...
#endif  //  MELON_CONTAINER_DYNAMIC_BITSET_H_
