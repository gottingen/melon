...
#ifndef MELON_CONTAINER_CACHE_RAW_CONFIG_H_
#define MELON_CONTAINER_CACHE_RAW_CONFIG_H_
...
namespace melon {
    ...
    public:
        ...
        void on_cache_set(const Key &key, const Value &value) override {
            ...
            MELON_LOG(DEBUG)<<"cache set, ram_bytes_used_: " << ram_bytes_used_;
...
#endif  // MELON_CONTAINER_CACHE_RAW_CONFIG_H_
