...
#ifndef MELON_CONTAINER_LRU_CACHE_H_
#define MELON_CONTAINER_LRU_CACHE_H_
...
#include "melon/container/cache/bucket.h"
#include "melon/container/parallel_ring_queue.h"
#include "melon/container/cache/config.h"
#include "melon/container/cache/item.h"
#include "melon/container/cache/policy.h"
#include "melon/container/cache/ram_policy.h"
...
namespace melon {
    ...
    private:
        ...
        void init() {
            ...
            MELON_LOG(INFO) << "init cache config successfully, max_item_num: "
        ...
        void gc() {
            MELON_LOG(DEBUG) << "cache do gc, list_size: " << list_.size();
...
#endif  // MELON_CONTAINER_LRU_CACHE_H_
