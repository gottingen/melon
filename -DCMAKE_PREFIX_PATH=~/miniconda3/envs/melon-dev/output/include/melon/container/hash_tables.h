...
#ifndef MELON_CONTAINER_HASH_TABLES_H_
#define MELON_CONTAINER_HASH_TABLES_H_
...
#define MELON_HASH_NAMESPACE stdext

#elif defined(MELON_COMPILER_GNUC) || defined(MELON_COMPILER_CLANG)
#if defined(MELON_PLATFORM_ANDROID)
#define MELON_HASH_NAMESPACE std
#else
#define MELON_HASH_NAMESPACE __gnu_cxx
#endif
...
#endif  // !defined(MELON_PLATFORM_ANDROID)
...
#else  // COMPILER
#error define MELON_HASH_NAMESPACE for your compiler
#endif  // COMPILER

namespace melon::container {
using MELON_HASH_NAMESPACE::hash_map;
using MELON_HASH_NAMESPACE::hash_multimap;
using MELON_HASH_NAMESPACE::hash_multiset;
using MELON_HASH_NAMESPACE::hash_set;

// Implement hashing for pairs of at-most 32 bit integer values.
inline std::size_t HashInts32(uint32_t value1, uint32_t value2) {
  uint64_t value1_64 = value1;
  uint64_t hash64 = (value1_64 << 32) | value2;
  return static_cast<size_t>(melon::hash::fmix64(hash64));
}
...
inline std::size_t hash_value(const std::pair<Type1, Type2>& value) {
  return melon::container::hash_pair(value.first, value.second);
}
...
#endif  // MELON_CONTAINER_HASH_TABLES_H_
