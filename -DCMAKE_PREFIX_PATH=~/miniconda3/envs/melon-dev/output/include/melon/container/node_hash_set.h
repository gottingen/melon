...
#ifndef MELON_CONTAINER_NODE_HASH_SET_H_
#define MELON_CONTAINER_NODE_HASH_SET_H_
...
namespace melon {
    ...
    // melon::node_hash_set
    // -----------------------------------------------------------------------------
    // An `melon::node_hash_set<T>` is an unordered associative container which
    ...
    class node_hash_set
            : public melon::priv::raw_hash_set<
                    melon::priv::node_hash_set_policy<T>, Hash, Eq, Alloc> {
...
#endif  // MELON_CONTAINER_NODE_HASH_SET_H_
