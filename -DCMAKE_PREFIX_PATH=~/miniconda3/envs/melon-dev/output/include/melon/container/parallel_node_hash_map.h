...
#ifndef MELON_CONTAINER_PARALLEL_NODE_HASH_MAP_H_
#define MELON_CONTAINER_PARALLEL_NODE_HASH_MAP_H_

#include "melon/container/internal/raw_hash_set.h"

namespace melon {
    // -----------------------------------------------------------------------------
    // melon::parallel_node_hash_map
    // -----------------------------------------------------------------------------
    template<class Key, class Value, class Hash, class Eq, class Alloc, size_t N, class Mtx_>
    class parallel_node_hash_map
            : public melon::priv::parallel_hash_map<
...
#endif  // MELON_CONTAINER_PARALLEL_NODE_HASH_MAP_H_
