...
namespace cereal
{
    ...
    void save(typename std::enable_if<melon_triv_copyable<K>::value && melon_triv_copyable<V>::value, typename cereal::BinaryOutputArchive>::type &ar,
    ...
    template <class K, class V, class Hash, class Eq, class A>
    void load(typename std::enable_if<melon_triv_copyable<K>::value && melon_triv_copyable<V>::value, typename cereal::BinaryInputArchive>::type &ar,
    ...
    void save(typename std::enable_if<melon_triv_copyable<K>::value, typename cereal::BinaryOutputArchive>::type &ar,
    ...
    template <class K, class Hash, class Eq, class A>
    void load(typename std::enable_if<melon_triv_copyable<K>::value, typename cereal::BinaryInputArchive>::type &ar,
