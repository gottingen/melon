...
#ifndef MELON_CONTAINER_FLAT_HASH_SET_H_
#define MELON_CONTAINER_FLAT_HASH_SET_H_
...
namespace melon {
    ...
    // melon::flat_hash_set
    // -----------------------------------------------------------------------------
    // An `melon::flat_hash_set<T>` is an unordered associative container which has
    ...
    class flat_hash_set
            : public melon::priv::raw_hash_set<
                    melon::priv::flat_hash_set_policy<T>, Hash, Eq, Alloc> {
...
#endif  // MELON_CONTAINER_FLAT_HASH_SET_H_
