...
#ifndef MELON_CONTAINER_NODE_HASH_MAP_H_
#define MELON_CONTAINER_NODE_HASH_MAP_H_
...
namespace melon {
    ...
    // -----------------------------------------------------------------------------
    //
    // An `melon::node_hash_map<K, V>` is an unordered associative container which
    ...
    class node_hash_map
            : public melon::priv::raw_hash_map<
                    melon::priv::node_hash_map_policy<Key, Value>, Hash, Eq,
                    Alloc> {
...
#endif  // MELON_CONTAINER_NODE_HASH_MAP_H_
