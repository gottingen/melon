...
#ifndef  MELON_CONTAINER_ROBIN_SET_H_
#define  MELON_CONTAINER_ROBIN_SET_H_
 ...
 * By default the set uses `melon::rh::power_of_two_growth_policy`. This policy keeps the number of buckets
 ...
 */
    ...
    /**
     * Same as `melon::robin_set<Key, Hash, KeyEqual, Allocator, StoreHash, melon::rh::prime_growth_policy>`.
     */
    template<class Key,
            class Hash = std::hash<Key>,
            class KeyEqual = std::equal_to<Key>,
            class Allocator = std::allocator<Key>,
            bool StoreHash = false>
    using robin_pg_set = robin_set<Key, Hash, KeyEqual, Allocator, StoreHash, melon::rh::prime_growth_policy>;

} // end namespace melon

#endif  // MELON_CONTAINER_ROBIN_SET_H_
