...
#ifndef MELON_CONTAINER_ROBIN_HASH_H_
#define MELON_CONTAINER_ROBIN_HASH_H_
...
#include <utility>
#include <vector>
#include "melon/container/robin_growth_policy.h"
...
namespace melon {
    ...
    namespace detail_robin_hash {
        ...
        struct is_power_of_two_policy<melon::rh::power_of_two_growth_policy<GrowthFactor>> : std::true_type {
        };
 ...
 */
        ...
        public:
            ...
            void set_value_of_empty_bucket(distance_type dist_from_ideal_bucket,
                ...
                MELON_CHECK(dist_from_ideal_bucket >= 0);
                MELON_CHECK(empty());
 ...
 */
        ...
        private:
            ...
            static constexpr bool STORE_HASH = StoreHash ||
                                               (
                                                       (sizeof(melon::detail_robin_hash::bucket_entry<value_type, true>) ==
                                                        sizeof(melon::detail_robin_hash::bucket_entry<value_type, false>))
                                                       &&
            ...
            using bucket_entry = melon::detail_robin_hash::bucket_entry<value_type, STORE_HASH>;
        ...
        public:
            robin_hash(size_type bucket_count,
                ...
                if (bucket_count > max_bucket_count()) {
                    MELON_THROW_OR_TERMINATE(std::length_error, "The map exceeds its maxmimum size.");
                }
            ...
            void insert(InputIt first, InputIt last) {
                if (std::is_base_of<std::forward_iterator_tag,
                    ...
                    MELON_CHECK(m_load_threshold >= size());
            ...
            iterator erase(const_iterator first, const_iterator last) {
                ...
                MELON_CHECK(ito_move_closer_value > icloser_bucket);
                ...
                while (ito_move_closer_value < m_buckets.size() &&
                    ...
                    MELON_CHECK(m_buckets[icloser_bucket].empty());
            ...
            const typename U::value_type &at(const K &key, std::size_t hash) const {
                ...
                if (it != cend()) {
                    ...
                    MELON_THROW_OR_TERMINATE(std::out_of_range, "Couldn't find key.");
                }
            }
        ...
        private:
            ...
            std::size_t bucket_for_hash(std::size_t hash) const {
                ...
                MELON_CHECK(bucket < m_buckets.size() || (bucket == 0 && m_buckets.empty()));
            ...
            std::size_t next_bucket(std::size_t index) const noexcept {
                MELON_CHECK(index < bucket_count());
            ...
            const_iterator find_impl(const K &key, std::size_t hash) const {
                ...
                while (dist_from_ideal_bucket <= (m_first_or_empty_bucket + ibucket)->dist_from_ideal_bucket()) {
                    if (MELON_LIKELY((!USE_STORED_HASH_ON_LOOKUP ||
            ...
            void erase_from_bucket(iterator pos) {
                ...
                while (m_buckets[ibucket].dist_from_ideal_bucket() > 0) {
                    MELON_CHECK(m_buckets[previous_ibucket].empty());
...
#endif  // MELON_CONTAINER_ROBIN_HASH_H_
