...
#ifndef MELON_CONTAINER_BTREE_H_
#define MELON_CONTAINER_BTREE_H_
...
#include "melon/container/internal/map_fwd_decl.h"
#include "melon/container/internal/map_base.h"
...
namespace melon {
    ...
    namespace type_traits_internal {
        ...
        struct IsTriviallyMoveConstructibleObject
                : std::integral_constant<
                        bool, std::is_move_constructible<
                              ...
                              melon::is_trivially_destructible<T>::value> {
        };
        ...
        struct IsTriviallyMoveAssignableReference<T &>
                : melon::is_trivially_move_assignable<T>::type {
        };
    ...
    namespace type_traits_internal {
        ...
        class is_trivially_copyable_impl {
            ...
            static constexpr bool kIsCopyOrMoveAssignable =
                    melon::is_copy_assignable<ExtentsRemoved>::value ||
                    melon::is_move_assignable<ExtentsRemoved>::value;
    ...
    namespace swap_internal {
        ...
        // This declaration prevents global `swap` and `melon::swap` overloads from being
        ...
        template<class T>
        struct IsSwappable
                : melon::type_traits_internal::is_detected<IsSwappableImpl, T> {
        };

        template<class T>
        struct IsNothrowSwappable
                : melon::type_traits_internal::is_detected<IsNothrowSwappableImpl, T> {
        };

        template<class T, melon::enable_if_t<IsSwappable<T>::value, int> = 0>
...
#define MELON_COMPARE_INLINE_BASECLASS_DECL(name)

#define MELON_COMPARE_INLINE_SUBCLASS_DECL(type, name)  \
        static const type name;

#define MELON_COMPARE_INLINE_INIT(type, name, init) \
...
#define MELON_COMPARE_INLINE_INIT(type, name, init)             \
        ...
        struct weak_equality_base {
            MELON_COMPARE_INLINE_BASECLASS_DECL(equivalent)
            MELON_COMPARE_INLINE_BASECLASS_DECL(nonequivalent)
        };

        template<typename T>
        struct strong_equality_base {
            MELON_COMPARE_INLINE_BASECLASS_DECL(equal)
            MELON_COMPARE_INLINE_BASECLASS_DECL(nonequal)
            MELON_COMPARE_INLINE_BASECLASS_DECL(equivalent)
            MELON_COMPARE_INLINE_BASECLASS_DECL(nonequivalent)
        };
        ...
        struct partial_ordering_base {
            MELON_COMPARE_INLINE_BASECLASS_DECL(less)
            MELON_COMPARE_INLINE_BASECLASS_DECL(equivalent)
            MELON_COMPARE_INLINE_BASECLASS_DECL(greater)
            MELON_COMPARE_INLINE_BASECLASS_DECL(unordered)
        };
    ...
    public:
        MELON_COMPARE_INLINE_SUBCLASS_DECL(weak_equality, equivalent)
        MELON_COMPARE_INLINE_SUBCLASS_DECL(weak_equality, nonequivalent)
    ...
    MELON_COMPARE_INLINE_INIT(weak_equality, equivalent,
                              compare_internal::eq::equivalent);
    MELON_COMPARE_INLINE_INIT(weak_equality, nonequivalent,
    ...
    public:
        MELON_COMPARE_INLINE_SUBCLASS_DECL(strong_equality, equal)
        MELON_COMPARE_INLINE_SUBCLASS_DECL(strong_equality, nonequal)
        MELON_COMPARE_INLINE_SUBCLASS_DECL(strong_equality, equivalent)
        MELON_COMPARE_INLINE_SUBCLASS_DECL(strong_equality, nonequivalent)
    ...
    MELON_COMPARE_INLINE_INIT(strong_equality, equal, compare_internal::eq::equal);
    MELON_COMPARE_INLINE_INIT(strong_equality, nonequal,
                              compare_internal::eq::nonequal);
    MELON_COMPARE_INLINE_INIT(strong_equality, equivalent,
                              compare_internal::eq::equivalent);
    MELON_COMPARE_INLINE_INIT(strong_equality, nonequivalent,
                              compare_internal::eq::nonequivalent);
    ...
    public:
        MELON_COMPARE_INLINE_SUBCLASS_DECL(partial_ordering, less)
        MELON_COMPARE_INLINE_SUBCLASS_DECL(partial_ordering, equivalent)
        MELON_COMPARE_INLINE_SUBCLASS_DECL(partial_ordering, greater)
        MELON_COMPARE_INLINE_SUBCLASS_DECL(partial_ordering, unordered)
    ...
    MELON_COMPARE_INLINE_INIT(partial_ordering, less, compare_internal::ord::less);
    MELON_COMPARE_INLINE_INIT(partial_ordering, equivalent,
                              compare_internal::eq::equivalent);
    MELON_COMPARE_INLINE_INIT(partial_ordering, greater,
                              compare_internal::ord::greater);
    MELON_COMPARE_INLINE_INIT(partial_ordering, unordered,
    ...
    public:
        MELON_COMPARE_INLINE_SUBCLASS_DECL(weak_ordering, less)
        MELON_COMPARE_INLINE_SUBCLASS_DECL(weak_ordering, equivalent)
        MELON_COMPARE_INLINE_SUBCLASS_DECL(weak_ordering, greater)
    ...
    MELON_COMPARE_INLINE_INIT(weak_ordering, less, compare_internal::ord::less);
    MELON_COMPARE_INLINE_INIT(weak_ordering, equivalent,
                              compare_internal::eq::equivalent);
    MELON_COMPARE_INLINE_INIT(weak_ordering, greater,
                              compare_internal::ord::greater);
    ...
    public:
        MELON_COMPARE_INLINE_SUBCLASS_DECL(strong_ordering, less)
        MELON_COMPARE_INLINE_SUBCLASS_DECL(strong_ordering, equal)
        MELON_COMPARE_INLINE_SUBCLASS_DECL(strong_ordering, equivalent)
        MELON_COMPARE_INLINE_SUBCLASS_DECL(strong_ordering, greater)
    ...
    MELON_COMPARE_INLINE_INIT(strong_ordering, less, compare_internal::ord::less);
    MELON_COMPARE_INLINE_INIT(strong_ordering, equal, compare_internal::eq::equal);
    MELON_COMPARE_INLINE_INIT(strong_ordering, equivalent,
                              compare_internal::eq::equivalent);
    MELON_COMPARE_INLINE_INIT(strong_ordering, greater,
                              compare_internal::ord::greater);

#undef MELON_COMPARE_INLINE_BASECLASS_DECL
#undef MELON_COMPARE_INLINE_SUBCLASS_DECL
#undef MELON_COMPARE_INLINE_INIT
    ...
    namespace compare_internal {
        ...
        template<typename BoolType,
                melon::enable_if_t<std::is_same<bool, BoolType>::value, int> = 0>
        constexpr bool compare_result_as_less_than(const BoolType r) { return r; }

        constexpr bool compare_result_as_less_than(const melon::weak_ordering r) {
            return r < 0;
        }
        ...
        template<typename Int,
                melon::enable_if_t<std::is_same<int, Int>::value, int> = 0>
        constexpr melon::weak_ordering compare_result_as_ordering(const Int c) {
            return c < 0 ? melon::weak_ordering::less
                         : c == 0 ? melon::weak_ordering::equivalent
                                  : melon::weak_ordering::greater;
        }

        constexpr melon::weak_ordering compare_result_as_ordering(
                const melon::weak_ordering c) {
            return c;
        }

        template<
                typename Compare, typename K, typename LK,
                melon::enable_if_t<!std::is_same<bool, melon::invoke_result_t<
                        Compare, const K &, const LK &>>::value,
                        int> = 0>
        constexpr melon::weak_ordering do_three_way_comparison(const Compare &compare,
        ...
        template<
                typename Compare, typename K, typename LK,
                melon::enable_if_t<std::is_same<bool, melon::invoke_result_t<Compare,
                        const K &, const LK &>>::value,
                        int> = 0>
        constexpr melon::weak_ordering do_three_way_comparison(const Compare &compare,
                                                               const K &x, const LK &y) {
            return compare(x, y) ? melon::weak_ordering::less
                                 : compare(y, x) ? melon::weak_ordering::greater
                                                 : melon::weak_ordering::equivalent;
        }
...
namespace melon {
    ...
    namespace priv {
        ...
        std::is_convertible<melon::invoke_result_t<Compare, const T &, const T &>,
                melon::weak_ordering>;
        ...
        struct StringBtreeDefaultLess {
            ...
            StringBtreeDefaultLess(melon::less<std::string_view>) {}  // NOLINT

            melon::weak_ordering operator()(std::string_view lhs,
        ...
        template<>
        struct key_compare_to_adapter<melon::less<std::string>> {
            using type = StringBtreeDefaultLess;
        };
        ...
        template<>
        struct key_compare_to_adapter<melon::less<std::string_view>> {
            using type = StringBtreeDefaultLess;
        };
        ...
        struct common_params {
            ...
            melon::conditional_t<(kNodeValueSpace / sizeof(value_type) >
        ...
        struct map_params : common_params<Key, Compare, Alloc, TargetNodeSize, Multi,
                melon::priv::map_slot_policy<Key, Data>> {
        ...
        struct set_slot_policy {
            ...
            static void construct(Alloc *alloc, slot_type *slot, Args &&... args) {
                melon::allocator_traits<Alloc>::construct(*alloc, slot,
                                                          std::forward<Args>(args)...);
            }

            template<typename Alloc>
            static void construct(Alloc *alloc, slot_type *slot, slot_type *other) {
                melon::allocator_traits<Alloc>::construct(*alloc, slot, std::move(*other));
            }

            template<typename Alloc>
            static void destroy(Alloc *alloc, slot_type *slot) {
                melon::allocator_traits<Alloc>::destroy(*alloc, slot);
            }
        ...
        struct upper_bound_adapter {
            ...
            bool operator()(const K &a, const LK &b) const {
                ...
                return !melon::compare_internal::compare_result_as_less_than(comp(b, a));
            }
        ...
        public:
            ...
            using use_linear_search = std::integral_constant<
                    ...
                    (std::is_same<melon::less<key_type>, key_compare>::value ||
        ...
        private:
            using layout_type = melon::priv::Layout<btree_node *, field_type,
        ...
        public:
            ...
            void clear_child(size_type i) {
                melon::priv::SanitizerPoisonObject(&mutable_child(i));
            }

            void set_child(size_type i, btree_node *c) {
                melon::priv::SanitizerUnpoisonObject(&mutable_child(i));
                mutable_child(i) = c;
            ...
            SearchResult<int, true> linear_search_impl(
                ...
                while (s < e) {
                    const melon::weak_ordering c = comp(key(s), k);
                    if (c == 0) {
            ...
            SearchResult<int, true> binary_search_impl(
                ...
                if (is_multi_container::value) {
                    ...
                    while (s != e) {
                        const int mid = (s + e) >> 1;
                        const melon::weak_ordering c = comp(key(mid), k);
                        if (c < 0) {
                            s = mid + 1;
                        } else {
                            e = mid;
            ...
            static btree_node *init_leaf(btree_node *n, btree_node *parent,
                ...
                melon::priv::SanitizerPoisonMemoryRegion(
        ...
        private:
            ...
            void value_init(const size_type i, allocator_type *alloc, Args &&... args) {
                melon::priv::SanitizerUnpoisonObject(slot(i));
                params_type::construct(alloc, slot(i), std::forward<Args>(args)...);
            }

            void value_destroy(const size_type i, allocator_type *alloc) {
                params_type::destroy(alloc, slot(i));
                melon::priv::SanitizerPoisonObject(slot(i));
            }
            ...
            void uninitialized_move_n(const size_type n, const size_type i,
                                      ...
                                      allocator_type *alloc) {
                melon::priv::SanitizerUnpoisonMemoryRegion(
        ...
        public:
            ...
            btree(btree &&x) noexcept
                    : root_(std::move(x.root_)),
                      rightmost_(melon::exchange(x.rightmost_, EmptyNode())),
                      size_(melon::exchange(x.size_, 0)) {
        ...
        private:
            ...
            node_type *allocate(const size_type sz) {
                return reinterpret_cast<node_type *>(
                        melon::priv::Allocate<node_type::Alignment()>(
            ...
            void deallocate(const size_type sz, node_type *node) {
                melon::priv::Deallocate<node_type::Alignment()>(
        ...
        private:
            ...
            melon::priv::CompressedTuple<key_compare, allocator_type,
                    node_type *>
                    root_;
        ...
        constexpr bool btree<P>::static_assert_validation() {
            ...
            // Verify that key_compare returns an melon::{weak,strong}_ordering or bool.
            using compare_result_type =
            melon::invoke_result_t<key_compare, key_type, key_type>;
            static_assert(
                    std::is_same<compare_result_type, bool>::value ||
                    std::is_convertible<compare_result_type, melon::weak_ordering>::value,
                    "key comparison function must return melon::{weak,strong}_ordering or "
                    "bool.");
        ...
        public:
            ...
            mapped_type &at(const key_arg<K> &key) {
                auto it = this->find(key);
                if (it == this->end())
                    base_internal::ThrowStdOutOfRange("melon::btree_map::at");
                return it->second;
            }
    ...
    // Swaps the contents of two `melon::btree_set` containers.
    // -------------------------------------------------------
    ...
    // Swaps the contents of two `melon::btree_multiset` containers.
    // ------------------------------------------------------------
    template<typename K, typename C, typename A>
    ...
    // Swaps the contents of two `melon::btree_map` containers.
    // -------------------------------------------------------
    ...
    // Swaps the contents of two `melon::btree_multimap` containers.
    // ------------------------------------------------------------
    template<typename K, typename V, typename C, typename A>
...
#endif  // MELON_CONTAINER_BTREE_H_
