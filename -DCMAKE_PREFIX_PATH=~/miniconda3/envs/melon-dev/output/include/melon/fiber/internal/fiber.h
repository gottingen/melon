...
#ifndef MELON_INTHERNAL_FIBER_H_
#define MELON_INTHERNAL_FIBER_H_
...
#  include <iostream>
#  include "melon/fiber/internal/mutex.h"        // use fiber_mutex_t in the RAII way

#endif

#include "melon/fiber/internal/token.h"
...
// differently:
//   melon::fiber_sleep_for(): returns -1 and sets errno to ESTOP if fiber_stop()
...
#endif  // MELON_INTHERNAL_FIBER_H_
