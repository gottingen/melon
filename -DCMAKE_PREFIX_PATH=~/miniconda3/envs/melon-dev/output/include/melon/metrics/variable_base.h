...
#ifndef  MELON_VARIABLE_VARIABLE_BASE_H_
#define  MELON_VARIABLE_VARIABLE_BASE_H_
...
namespace std {
    ...
    inline ostream &operator<<(ostream &os, const ::melon::variable_base &var) {
...
#endif  // MELON_VARIABLE_VARIABLE_BASE_H_
