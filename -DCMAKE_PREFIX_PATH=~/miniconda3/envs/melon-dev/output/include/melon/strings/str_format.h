...
#ifndef MELON_STRING_STR_FORMAT_H_
#define MELON_STRING_STR_FORMAT_H_
...
namespace melon {
    ...
    using string_output_stream = ::melon::strings_internal::string_output_stream;
...
#endif  // MELON_STRING_STR_FORMAT_H_
