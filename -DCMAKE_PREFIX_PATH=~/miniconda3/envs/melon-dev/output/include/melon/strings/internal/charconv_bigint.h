...
#ifndef MELON_STRINGS_INTERNAL_CHARCONV_BIGINT_H_
#define MELON_STRINGS_INTERNAL_CHARCONV_BIGINT_H_
...
// large integer math, but a design goal of melon::from_chars is to avoid
...
#endif  // MELON_STRINGS_INTERNAL_CHARCONV_BIGINT_H_
