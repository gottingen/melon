...
#ifndef MELON_STRINGS_STR_SPLIT_H_
#define MELON_STRINGS_STR_SPLIT_H_
...
#include "melon/strings/internal/str_split_internal.h"
...
namespace melon {
    ...
    // Example:
    //
    //   // Because a string literal is converted to an `melon::by_string`,
    ...
    // Example:
    //
    //   // Because a char literal is converted to a melon::by_char,
    //   // the following two splits are equivalent.
    //   std::vector<std::string> v1 = melon:: string_split("a,b,c", ',');
    //   using melon::by_char;
    //   std::vector<std::string> v2 = melon:: string_split("a,b,c", by_char(','));
    //   // v[0] == "a", v[1] == "b", v[2] == "c"
    //
    ...
    //
    //   using melon::by_char;
    //   std::vector<std::string> v = melon:: string_split("a-b", by_char('-'));
    //
    class by_char {
    public:
    ...
    //   std::vector<std::string> v = melon:: string_split("123456789",  by_length(3));
    ...
    //
    //   using melon:: by_length;
    //   std::vector<std::string> v = melon:: string_split("12345",  by_length(2));
    //
    //   // v[0] == "12", v[1] == "34", v[2] == "5"
    class by_length {
    public:
    ...
    namespace strings_internal {
        ...
        // This allows functions like melon:: string_split() and melon:: max_splits() to accept
    ...
    // Example:
    //
    //   using melon:: max_splits;
    //   std::vector<std::string> v = melon:: string_split("a,b,c",  max_splits(',', 1));
    //
    //   // v[0] == "a", v[1] == "b,c"
    template<typename Delimiter>
    MELON_FORCE_INLINE strings_internal::max_splits_impl<
    ...
    // Example:
    //
    //  std::vector<std::string> v = melon:: string_split(" a , ,,b,", ',',  allow_empty());
    //
    ...
    // Example:
    //
    //   std::vector<std::string> v = melon:: string_split(",a,,b,", ',',  skip_empty());
    //
    //   // v[0] == "a", v[1] == "b"
    //
    ...
    //   std::map<std::string, std::string> m = melon:: string_split("a,b,c", ',');
    ...
    //
    //   melon:: string_split(std::string_view(""), '-');  // {""}
    //   melon:: string_split(std::string_view(), '-');    // {}, but should be {""}
    //
...
#endif  // MELON_STRINGS_STR_SPLIT_H_
