...
#ifndef MELON_STRINGS_ESCAPING_H_
#define MELON_STRINGS_ESCAPING_H_
...
//   if (!melon::unescape(s, &unescaped_s) {
//     ...
//   }
...
MELON_FORCE_INLINE bool unescape(std::string_view source, std::string *dest) {
...
//   std::string escaped_s = melon::escape(s);
...
//
//   std::string s = "foo\rbar\tbaz\010\011\012\013\014\x0d\n";
//   std::string escaped_s = melon::hex_escape(s);
...
#endif  // MELON_STRINGS_ESCAPING_H_
