...
// melon/strings/str_split.h.
//

#ifndef MELON_STRINGS_INTERNAL_STR_SPLIT_INTERNAL_H_
#define MELON_STRINGS_INTERNAL_STR_SPLIT_INTERNAL_H_
...
namespace melon::strings_internal {
    ...
    struct splitter_is_convertible_to
            : splitter_is_convertible_to_impl<C,
                    ...
                    melon::has_value_type<C>::value && melon::has_const_iterator<C>::value,
                    melon::has_mapped_type<C>::value> {
    };

    // This class implements the range that is returned by melon:: string_split(). This
...
#endif  // MELON_STRINGS_INTERNAL_STR_SPLIT_INTERNAL_H_
