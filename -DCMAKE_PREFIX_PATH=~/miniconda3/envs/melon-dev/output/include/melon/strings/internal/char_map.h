...
#ifndef MELON_STRINGS_INTERNAL_CHAR_MAP_H_
#define MELON_STRINGS_INTERNAL_CHAR_MAP_H_
...
class Charmap {
  public:
    ...
    bool IntersectsWith(const Charmap &c) const {
        for (size_t i = 0; i < MELON_ARRAY_SIZE(m_); ++i) {
...
#endif  // MELON_STRINGS_INTERNAL_CHAR_MAP_H_
