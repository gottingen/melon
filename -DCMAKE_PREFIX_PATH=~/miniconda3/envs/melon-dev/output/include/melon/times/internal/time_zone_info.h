...
#ifndef MELON_TIMES_INTERNAL_TIME_ZONE_INFO_H_
#define MELON_TIMES_INTERNAL_TIME_ZONE_INFO_H_
...
#include "melon/times/internal/time_zone_if.h"
#include "melon/times/internal/tzfile.h"
...
// A transition to a new UTC offset.
    struct transition {
        ...
        struct by_unix_time {
            MELON_FORCE_INLINE bool operator()(const transition &lhs, const transition &rhs) const {
...
#endif  // MELON_TIMES_INTERNAL_TIME_ZONE_INFO_H_
