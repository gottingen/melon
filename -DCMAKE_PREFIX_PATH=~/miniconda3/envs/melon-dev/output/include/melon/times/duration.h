 ...
 *****************************************************************/
#ifndef MELON_TIMES_DURATION_H_
#define MELON_TIMES_DURATION_H_
...
// Additive Operators
    ...
    // duration
    //
    // The `melon::duration` class represents a signed, fixed-length span of time.
    // A `duration` is generated using a unit-specific factory function, or is
    // the result of subtracting one `melon::time_point` from another. Durations behave
    ...
    // Examples:
    //
    //   constexpr melon::duration ten_ns = melon::nanoseconds(10);
    //   constexpr melon::duration min = melon::minutes(1);
    //   constexpr melon::duration hour = melon::hours(1);
    //   melon::duration dur = 60 * min;  // dur == hour
    //   melon::duration half_sec = melon::milliseconds(500);
    //   melon::duration quarter_sec = 0.25 * melon::seconds(1);
    //
    ...
    // Example:
    //
    //   constexpr melon::duration dur = melon::milliseconds(1500);
    //   int64_t ns = dur / melon::nanoseconds(1);   // ns == 1500000000
    //   int64_t ms = dur / melon::milliseconds(1);  // ms == 1500
    //   int64_t sec = dur / melon::seconds(1);    // sec == 1 (subseconds truncated)
    //   int64_t min = dur / melon::minutes(1);    // min == 0
    //
    ...
    public:
        ...
        // Example:
        //
        //   melon::duration d = melon::milliseconds(1500);
        ...
        //
        //   melon::duration d = melon::milliseconds(1500);
        //   double dsec = melon::ToDoubleSeconds(d);  // dsec == 1.5
        ...
        // Example:
        //
        //   double d = melon::float_div_duration(melon::milliseconds(1500), melon::seconds(1));
        //   // d == 1.5
        ...
        // Example:
        //
        //   melon::duration d = melon::nanoseconds(123456789);
        //   melon::duration a = melon::trunc(melon::microseconds(1));  // 123456us
        ...
        //
        //   melon::duration d = melon::nanoseconds(123456789);
        //   melon::duration b = melon::floor(melon::microseconds(1));  // 123456us
        ...
        //
        //   melon::duration d = melon::nanoseconds(123456789);
        //   melon::duration c = melon::ceil(melon::microseconds(1));   // 123457us
    ...
    public:
        ...
        // `melon::duration::hours(24)`. If you actually want a civil day, use melon::chrono_day
        // from civil_time.h.
        //
        // Example:
        //
        //   melon::duration a = melon::duration::seconds(60);
        //   melon::duration b = melon::duration::minutes(1);  // b == a
        ...
        // Example:
        //
        //   auto a = melon::seconds(1.5);        // OK
        //   auto b = melon::milliseconds(1500);  // BETTER
        ...
        // from_chrono()
        //
        // Converts any of the pre-defined std::chrono durations to an melon::duration.
        //
        // Example:
        //
        //   std::chrono::milliseconds ms(123);
        //   melon::duration d = melon::from_chrono(ms);
    ...
    public:
        ...
        // Converts a std::chrono::duration to an melon::duration.
    ...
    public:
        ...
        // Converts an melon::duration to a chrono duration of type T.
        template<typename T>
        ...
        //note that these interface use by melon internal
    ...
    namespace times_internal {
        MELON_FORCE_INLINE bool is_valid_divisor(double d) {
        ...
        MELON_FORCE_INLINE void normalize_ticks(int64_t *sec, int64_t *ticks) {
            if (*ticks < 0) {
                --*sec;
        ...
        MELON_FORCE_INLINE uint64_t encode_twos_comp(int64_t v) {
            return melon::base::bit_cast<uint64_t>(v);
        }

        MELON_FORCE_INLINE int64_t decode_twos_comp(uint64_t v) { return melon::base::bit_cast<int64_t>(v); }
    ...
    MELON_FORCE_INLINE duration operator+(duration lhs, duration rhs) { return lhs += rhs; }
    ...
    MELON_FORCE_INLINE int64_t operator/(duration lhs, duration rhs) {
    ...
    // Example:
    //
    //   constexpr melon::duration a =
    //       melon::seconds(std::numeric_limits<int64_t>::max());  // big
    //   constexpr melon::duration b = melon::nanoseconds(1);       // small
    //
    //   melon::duration rem = a % b;
    //   // rem == melon::zero_duration()
    //
    //   // Here, q would overflow int64_t, so rem accounts for the difference.
    //   int64_t q = melon::integer_div_duration(a, b, &rem);
    //   // q == std::numeric_limits<int64_t>::max(), rem == a - b * q
    MELON_FORCE_INLINE int64_t duration::integer_div_duration(duration num, duration den, duration *rem) {
    ...
    MELON_FORCE_INLINE duration abs_duration(duration d) {
    ...
    //   const melon::duration d = ... any finite duration ...
    //
    //   inf == inf + inf
    //   inf == inf + d
    //   inf == inf - inf
    ...
    //   inf == d / 0
    //   INT64_MAX == d / melon::zero_duration()
    //
    ...
    MELON_FORCE_INLINE std::ostream &operator<<(std::ostream &os, duration d) {
...
// Makes a uint128 count of ticks out of the absolute value of the duration.
    MELON_FORCE_INLINE uint128 duration::make_uint128_ticks() const {
...
// Breaks a uint128 of ticks into a duration.
    MELON_FORCE_INLINE duration duration::make_duration_from_uint128(uint128 u128, bool is_neg) {
        int64_t rep_hi;
        uint32_t rep_lo;
...
// Converts a std::chrono::duration to an melon::duration.
    ...
    MELON_FORCE_INLINE bool duration::safe_add_rep_hi(double a_hi, double b_hi) {
        double c = a_hi + b_hi;
    ...
    template<template<typename> class Operation>
    MELON_FORCE_INLINE duration duration::scale_fixed(int64_t r) {
    ...
    template<template<typename> class Operation>
    MELON_FORCE_INLINE duration duration::scale_double(double r) const {
        Operation<double> op;
        ...
        int64_t lo64 = melon::base::round(lo_frac * times_internal::kTicksPerSecond);
        duration ans;
    ...
    MELON_FORCE_INLINE bool duration::i_div_fast_path(const duration den, int64_t *q,
                                                      duration *rem) const {
...
// Fastpath implementations for the 6 common duration units.
    MELON_FORCE_INLINE int64_t duration::to_int64(std::nano) const {
        return to_int64_nanoseconds();
    }

    MELON_FORCE_INLINE int64_t duration::to_int64(std::micro) const {
        return to_int64_microseconds();
    }

    MELON_FORCE_INLINE int64_t duration::to_int64(std::milli) const {
        return to_int64_milliseconds();
    }

    MELON_FORCE_INLINE int64_t duration::to_int64(std::ratio<1>) const {
        return to_int64_seconds();
    }

    MELON_FORCE_INLINE int64_t duration::to_int64(std::ratio<60>) const {
        return to_int64_minutes();
    }

    MELON_FORCE_INLINE int64_t duration::to_int64(std::ratio<3600>) const {
