...
//
// The melon time library allows you to construct such civil times from
...
//   const melon::chrono_day cd(1969, 07, 20);
//
//   // Construct a civil-time object for a specific second
//   const melon::chrono_second cd(2018, 8, 1, 12, 0, 1);
//
...
//
//   // Valid in C++14
//   constexpr melon::chrono_day cd(1969, 07, 20);

#ifndef MELON_TIMES_CIVIL_TIME_H_
#define MELON_TIMES_CIVIL_TIME_H_
...
namespace melon {
    ...
    namespace times_internal {
        struct second_tag : melon::times_internal::times_detail::second_tag {
        };
        struct minute_tag : second_tag, melon::times_internal::times_detail::minute_tag {
        };
        struct hour_tag : minute_tag, melon::times_internal::times_detail::hour_tag {
        };
        struct day_tag : hour_tag, melon::times_internal::times_detail::day_tag {
        };
        struct month_tag : day_tag, melon::times_internal::times_detail::month_tag {
        };
        struct year_tag : month_tag, melon::times_internal::times_detail::year_tag {
        };
    }  // namespace times_internal
    ...
    // Examples:
    //
    //   melon::chrono_day default_value;               // 1970-01-01 00:00:00
    //
    //   melon::chrono_day a(2015, 2, 3);               // 2015-02-03 00:00:00
    //   melon::chrono_day b(2015, 2, 3, 4, 5, 6);      // 2015-02-03 00:00:00
    //   melon::chrono_day c(2015);                     // 2015-01-01 00:00:00
    //
    //   melon::chrono_second ss(2015, 2, 3, 4, 5, 6);  // 2015-02-03 04:05:06
    //   melon::chrono_minute mm(ss);                   // 2015-02-03 04:05:00
    //   melon::chrono_hour hh(mm);                     // 2015-02-03 04:00:00
    //   melon::chrono_day d(hh);                       // 2015-02-03 00:00:00
    //   melon::chrono_month m(d);                      // 2015-02-01 00:00:00
    //   melon::chrono_year y(m);                       // 2015-01-01 00:00:00
    //
    //   m = melon::chrono_month(y);                    // 2015-01-01 00:00:00
    //   d = melon::chrono_day(m);                      // 2015-01-01 00:00:00
    //   hh = melon::chrono_hour(d);                    // 2015-01-01 00:00:00
    //   mm = melon::chrono_minute(hh);                 // 2015-01-01 00:00:00
    //   ss = melon::chrono_second(mm);                 // 2015-01-01 00:00:00
    //
    ...
    //
    //   melon::chrono_second   : 2015-11-22 12:34:56
    //   melon::chrono_minute   : 2015-11-22 12:34:00
    //   melon::chrono_hour     : 2015-11-22 12:00:00
    //   melon::chrono_day      : 2015-11-22 00:00:00
    //   melon::chrono_month    : 2015-11-01 00:00:00
    //   melon::chrono_year     : 2015-01-01 00:00:00
    //
    // Each civil-time type performs arithmetic on the field to which it is
    // aligned. This means that adding 1 to an melon::chrono_day increments the day
    // field (normalizing as necessary), and subtracting 7 from an melon::chrono_month
    ...
    // alignment. For example, the difference between two melon::chrono_hour objects
    ...
    // precision (e.g., melon::chrono_day -> melon::chrono_second), the conversion may be
    ...
    // Examples:
    //
    //   void UseDay(melon::chrono_day day);
    //
    //   melon::chrono_second cs;
    //   UseDay(cs);                  // Won't compile because data may be discarded
    //   UseDay(melon::chrono_day(cs));  // OK: explicit conversion
    //
    //   melon::chrono_day cd;
    //   UseDay(cd);                  // OK: no conversion needed
    //
    //   melon::chrono_month cm;
    //   UseDay(cm);                  // OK: implicit conversion to melon::chrono_day
    //
    // NORMALIZATION
    //
    ...
    //   melon::chrono_day d(2016, 10, 32);
    //   // Out-of-range, negative: normalized to 2016-10-30T23
    //   melon::chrono_hour h1(2016, 10, 31, -1);
    //   // Normalization is cumulative: normalized to 2016-10-30T23
    //   melon::chrono_hour h2(2016, 10, 32, -25);
    //
    ...
    // Examples:
    //
    //   melon::chrono_day feb_3(2015, 2, 3);  // 2015-02-03 00:00:00
    //   melon::chrono_day mar_4(2015, 3, 4);  // 2015-03-04 00:00:00
    //   // feb_3 < mar_4
    //   // melon::chrono_year(feb_3) == melon::chrono_year(mar_4)
    //
    //   melon::chrono_second feb_3_noon(2015, 2, 3, 12, 0, 0);  // 2015-02-03 12:00:00
    //   // feb_3 < feb_3_noon
    //   // feb_3 == melon::chrono_day(feb_3_noon)
    //
    //   // Iterates all the days of February 2015.
    //   for (melon::chrono_day d(2015, 2, 1); d < melon::chrono_month(2015, 3); ++d) {
    //     // ...
    //   }
    //
    // ARITHMETIC
    ...
    // Example:
    //
    //   melon::chrono_day a(2015, 2, 3);
    //   ++a;                              // 2015-02-04 00:00:00
    //   --a;                              // 2015-02-03 00:00:00
    //   melon::chrono_day b = a + 1;         // 2015-02-04 00:00:00
    //   melon::chrono_day c = 1 + b;         // 2015-02-05 00:00:00
    //   int n = c - a;                    // n = 2 (civil days)
    //   int m = c - melon::chrono_month(c);  // Won't compile: different types.
    //
    // ACCESSORS
    //
    ...
    // is the wrong answer.
    //
    // The melon time library avoids this problem by making it impossible to
    ...
    // this melon time library, but they require the programmer to be explicit
    ...
    // Example:
    //
    //   const melon::chrono_day d(2015, 1, 31);
    //
    //   // Answer 1:
    //   // Add 1 to the month field in the constructor, and rely on normalization.
    //   const auto normalized = melon::chrono_day(d.year(), d.month() + 1, d.day());
    //   // normalized == 2015-03-03 (aka Feb 31)
    //
    //   // Answer 2:
    //   // Add 1 to month field, capping to the end of next month.
    //   const auto next_month = melon::chrono_month(d) + 1;
    //   const auto last_day_of_next_month = melon::chrono_day(next_month + 1) - 1;
    //   const auto capped = std::min(normalized, last_day_of_next_month);
    //   // capped == 2015-02-28
    //
    //   // Answer 3:
    //   // signal an error if the normalized answer is not in next month.
    //   if (melon::chrono_month(normalized) != next_month) {
    //     // error, month overflow
    //   }
    //
    using chrono_second =
    melon::times_internal::times_detail::civil_time<times_internal::second_tag>;
    using chrono_minute =
    melon::times_internal::times_detail::civil_time<times_internal::minute_tag>;
    using chrono_hour =
    melon::times_internal::times_detail::civil_time<times_internal::hour_tag>;
    using chrono_day =
    melon::times_internal::times_detail::civil_time<times_internal::day_tag>;
    using chrono_month =
    melon::times_internal::times_detail::civil_time<times_internal::month_tag>;
    using chrono_year =
    melon::times_internal::times_detail::civil_time<times_internal::year_tag>;
    ...
    //
    //   melon::chrono_second cs = ...;
    //   melon::chrono_year_t y = cs.year();
    //   cs = melon::chrono_second(y, 1, 1, 0, 0, 0);  // chrono_second(chrono_year(cs))
    //
    using chrono_year_t = melon::times_internal::year_t;
    ...
    // Example:
    //
    //   melon::chrono_diff_t n_sec = cs1 - cs2;             // cs1 == cs2 + n_sec;
    //
    using chrono_diff_t = melon::times_internal::diff_t;
    ...
    //
    //   melon::chrono_weekday wd = melon::chrono_weekday::thursday;
    //::
    using chrono_weekday = melon::times_internal::times_detail::weekday;

    // get_weekday()
    //
    // Returns the melon::chrono_weekday for the given (realigned) civil-time value.
    //
    // Example:
    //
    //   melon::chrono_day a(2015, 8, 13);
    //   melon::chrono_weekday wd = melon::get_weekday(a);  // wd == melon::chrono_weekday::thursday
    //
    MELON_FORCE_INLINE chrono_weekday get_weekday(chrono_second cs) {
        return melon::times_internal::times_detail::get_weekday(cs);
    }

    // next_weekday()
    // prev_weekday()
    //
    // Returns the melon::chrono_day that strictly follows or precedes a given
    // melon::chrono_day, and that falls on the given melon::chrono_weekday.
    //
    ...
    //
    //   melon::chrono_day a(2015, 8, 13);
    //   // melon::get_weekday(a) == melon::chrono_weekday::thursday
    //   melon::chrono_day b = melon::next_weekday(a, melon::chrono_weekday::thursday);
    //   // b = 2015-08-20
    //   melon::chrono_day c = melon::prev_weekday(a, melon::chrono_weekday::thursday);
    //   // c = 2015-08-06
    //
    //   melon::chrono_day d = ...
    //   // Gets the following Thursday if d is not already Thursday
    //   melon::chrono_day thurs1 = melon::next_weekday(d - 1, melon::chrono_weekday::thursday);
    //   // Gets the previous Thursday if d is not already Thursday
    //   melon::chrono_day thurs2 = melon::prev_weekday(d + 1, melon::chrono_weekday::thursday);
    //
    MELON_FORCE_INLINE chrono_day next_weekday(chrono_day cd, chrono_weekday wd) {
        return chrono_day(melon::times_internal::times_detail::next_weekday(cd, wd));
    }

    MELON_FORCE_INLINE chrono_day prev_weekday(chrono_day cd, chrono_weekday wd) {
        return chrono_day(melon::times_internal::times_detail::prev_weekday(cd, wd));
    }
    ...
    // Example:
    //
    //   melon::chrono_day a(2015, 1, 1);
    //   int yd_jan_1 = melon::get_yearday(a);   // yd_jan_1 = 1
    //   melon::chrono_day b(2015, 12, 31);
    //   int yd_dec_31 = melon::get_yearday(b);  // yd_dec_31 = 365
    //
    MELON_FORCE_INLINE int get_yearday(chrono_second cs) {
        return melon::times_internal::times_detail::get_yearday(cs);
    }
    ...
    // Example:
    //
    //   melon::chrono_day d = melon::chrono_day(1969, 7, 20);
    //   std::string day_string = melon::format_chrono_time(d);  // "1969-07-20"
    //
    ...
    //
    //   melon::chrono_day d;
    //   bool ok = melon::parse_chrono_time("2018-01-02", &d); // OK
    //
    ...
    //
    // Parses any of the formats accepted by `melon::parse_chrono_time()`, but is more
    ...
    //
    //   melon::chrono_day d;
    //   bool ok = melon::ParseLenientCivilTime("1969-07-20", &d); // OK
    //   ok = melon::ParseLenientCivilTime("1969-07-20T10", &d);   // OK: T10 floored
    //   ok = melon::ParseLenientCivilTime("1969-07", &d);   // OK: day defaults to 1
    //
...
#endif  // MELON_TIMES_CIVIL_TIME_H_
