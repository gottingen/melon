...
#ifndef MELON_BASE_TYPE_INDEX_H_
#define MELON_BASE_TYPE_INDEX_H_
...
namespace std {
    ...
    template <>
    struct hash<melon::base::type_index> {
        size_t operator()(const melon::base::type_index& type) const noexcept {
...
#endif  // MELON_BASE_TYPE_INDEX_H_
