...
#ifndef MELON_BASE_FAST_RAND_H_
#define MELON_BASE_FAST_RAND_H_
...
namespace melon::base {
    ...
    //   std::random_shuffle(myvector.begin(), myvector.end(), melon::base::fast_rand_less_than);
