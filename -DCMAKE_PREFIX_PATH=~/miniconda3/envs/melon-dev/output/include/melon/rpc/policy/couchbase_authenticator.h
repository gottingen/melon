...
#ifndef MELON_RPC_POLICY_COUCHBASE_AUTHENTICATOR_H_
#define MELON_RPC_POLICY_COUCHBASE_AUTHENTICATOR_H_
...
namespace melon::rpc {
    namespace policy {
        ...
        public:
            ...
            int VerifyCredential(const std::string &, const melon::base::end_point &,
