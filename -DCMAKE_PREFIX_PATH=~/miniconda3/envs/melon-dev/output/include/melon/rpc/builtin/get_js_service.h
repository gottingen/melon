...
#ifndef  MELON_RPC_GET_JAVASCRIPT_SERVICE_H_
#define  MELON_RPC_GET_JAVASCRIPT_SERVICE_H_
...
namespace melon::rpc {
    ...
    class GetJsService : public ::melon::rpc::js {
    public:
...
#endif  // MELON_RPC_GET_JAVASCRIPT_SERVICE_H_
