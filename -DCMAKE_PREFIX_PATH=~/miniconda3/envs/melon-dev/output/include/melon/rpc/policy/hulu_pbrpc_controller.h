...
#ifndef  MELON_RPC_HULU_PBRPC_CONTROLLER_H_
#define  MELON_RPC_HULU_PBRPC_CONTROLLER_H_
...
namespace melon::rpc {
    namespace policy {
        ...
        public:
            HuluController()
                    : _request_source_addr(0), _response_source_addr(0) {}
            ...
            void set_request_source_addr(int64_t request_source_addr) { _request_source_addr = request_source_addr; }
            ...
            void set_request_user_data(const std::string &request_user_data) { _request_user_data = request_user_data; }
            ...
            void
            set_response_source_addr(int64_t response_source_addr) { _response_source_addr = response_source_addr; }
            ...
            void
            set_response_user_data(const std::string &response_user_data) { _response_user_data = response_user_data; }
...
#endif  // MELON_RPC_HULU_PBRPC_CONTROLLER_H_
