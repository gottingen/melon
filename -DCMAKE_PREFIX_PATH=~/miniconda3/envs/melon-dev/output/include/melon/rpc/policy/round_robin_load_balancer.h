...
#ifndef MELON_RPC_POLICY_ROUND_ROBIN_LOAD_BALANCER_H_
#define MELON_RPC_POLICY_ROUND_ROBIN_LOAD_BALANCER_H_
...
#endif  // MELON_RPC_POLICY_ROUND_ROBIN_LOAD_BALANCER_H_
