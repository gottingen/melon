...
#ifndef MELON_RPC_BUILTIN_TABBED_H_
#define MELON_RPC_BUILTIN_TABBED_H_
...
namespace melon::rpc {
    ...
    //   ...
    //   void MySerivce::GetTabInfo(melon::rpc::TabInfoList* info_list) const {
    //     melon::rpc::TabInfo* info = info_list->add();
...
#endif // MELON_RPC_BUILTIN_TABBED_H_
