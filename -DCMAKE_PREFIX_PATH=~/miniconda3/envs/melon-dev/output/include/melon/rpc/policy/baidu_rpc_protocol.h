...
#ifndef MELON_RPC_POLICY_BRPC_PROTOCOL_H_
#define MELON_RPC_POLICY_BRPC_PROTOCOL_H_
...
namespace melon::rpc {
    namespace policy {
        ...
        ParseResult ParseRpcMessage(melon::cord_buf *source, Socket *socket, bool read_eof,
                                    const void *arg);
        ...
        void PackRpcRequest(melon::cord_buf *buf,
                            SocketMessage **,
...
#endif  // MELON_RPC_POLICY_BRPC_PROTOCOL_H_
