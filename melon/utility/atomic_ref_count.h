...
// counting.  Please use memory/ref_counted.h directly instead.
//
...
inline void AtomicRefCountInc(volatile AtomicRefCount *ptr) {
  mutil::AtomicRefCountIncN(ptr, 1);
}
...
inline bool AtomicRefCountDec(volatile AtomicRefCount *ptr) {
  return mutil::AtomicRefCountDecN(ptr, 1);
}
...
#endif  // MUTIL_ATOMIC_REF_COUNT_H_
