...
#include "melon/utility/atomicops_internals_tsan.h"
#elif defined(OS_WIN) && defined(COMPILER_MSVC) && defined(ARCH_CPU_X86_FAMILY)
#include "melon/utility/atomicops_internals_x86_msvc.h"
#elif defined(OS_MACOSX)
#include "melon/utility/atomicops_internals_mac.h"
#elif defined(OS_NACL)
#include "melon/utility/atomicops_internals_gcc.h"
#elif defined(COMPILER_GCC) && defined(ARCH_CPU_ARMEL)
#include "melon/utility/atomicops_internals_arm_gcc.h"
#elif defined(COMPILER_GCC) && defined(ARCH_CPU_ARM64)
#include "melon/utility/atomicops_internals_arm64_gcc.h"
#elif defined(COMPILER_GCC) && defined(ARCH_CPU_X86_FAMILY)
#include "melon/utility/atomicops_internals_x86_gcc.h"
#elif defined(COMPILER_GCC) && defined(ARCH_CPU_MIPS_FAMILY)
#include "melon/utility/atomicops_internals_mips_gcc.h"
...
#include "melon/utility/atomicops_internals_atomicword_compat.h"
#endif

// ========= Provide mutil::atomic<T> =========
...
MUTIL_FORCE_INLINE void atomic_thread_fence(memory_order v) {
    switch (v) {
...
MUTIL_FORCE_INLINE void atomic_signal_fence(memory_order v) {
...
// Example:
//   mutil::static_atomic<int> g_counter = MUTIL_STATIC_ATOMIC_INIT(0);
// Notice that to make static_atomic work for C++03, it cannot be
// initialized by a constructor. Following code is wrong:
//   mutil::static_atomic<int> g_counter(0); // Not compile

#define MUTIL_STATIC_ATOMIC_INIT(val) { (val) }
