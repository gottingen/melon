...
#ifndef MUTIL_ENVIRONMENT_H_
#define MUTIL_ENVIRONMENT_H_
...
#if defined(OS_POSIX)
MUTIL_EXPORT extern const char kHome[];
#endif

}  // namespace env_vars

class MUTIL_EXPORT Environment {
 public:
  virtual ~Environment();
...
MUTIL_EXPORT string16 AlterEnvironment(const wchar_t* env,
...
MUTIL_EXPORT scoped_ptr<char*[]> AlterEnvironment(
