...
#ifndef MUTIL_MAC_SCOPED_CFTYPEREF_H_
#define MUTIL_MAC_SCOPED_CFTYPEREF_H_

#include <CoreFoundation/CoreFoundation.h>

#include "melon/utility/mac/scoped_typeref.h"
...
class ScopedCFTypeRef
 ...
 public:
  ...
  explicit ScopedCFTypeRef(
      CFT object = NULL,
      mutil::scoped_policy::OwnershipPolicy policy = mutil::scoped_policy::ASSUME)
      : ScopedTypeRef<CFT,
...
#endif  // MUTIL_MAC_SCOPED_CFTYPEREF_H_
