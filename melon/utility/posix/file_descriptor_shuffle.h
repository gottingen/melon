...
#ifndef MUTIL_POSIX_FILE_DESCRIPTOR_SHUFFLE_H_
#define MUTIL_POSIX_FILE_DESCRIPTOR_SHUFFLE_H_
...
//   mutil::InjectiveMultimap file_descriptor_map;
//   file_descriptor_map.push_back(mutil::InjectionArc(devnull, 0, true));
//   file_descriptor_map.push_back(mutil::InjectionArc(devnull, 2, true));
//   file_descriptor_map.push_back(mutil::InjectionArc(pipe[1], 1, true));
//   mutil::ShuffleFileDescriptors(file_descriptor_map);
//
...
class MUTIL_EXPORT FileDescriptorTableInjection : public InjectionDelegate {
...
MUTIL_EXPORT bool PerformInjectiveMultimap(const InjectiveMultimap& map,
                                          InjectionDelegate* delegate);

MUTIL_EXPORT bool PerformInjectiveMultimapDestructive(
...
#endif  // MUTIL_POSIX_FILE_DESCRIPTOR_SHUFFLE_H_
