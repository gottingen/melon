...
#ifndef MUTIL_TICK_CLOCK_H_
#define MUTIL_TICK_CLOCK_H_
...
// non-decreasing time.
//
// See DefaultTickClock (time/default_tick_clock.h) for the default
...
//
// See SimpleTestTickClock (test/simple_test_tick_clock.h) for a
// simple test implementation.
//
// See Clock (time/clock.h) for the equivalent interface for Times.
class MUTIL_EXPORT TickClock {
 public:
  virtual ~TickClock();
