...
#ifndef MUTIL_SAFE_STRERROR_POSIX_H_
#define MUTIL_SAFE_STRERROR_POSIX_H_
...
MUTIL_EXPORT void safe_strerror_r(int err, char *buf, size_t len);
...
// allocate a string.
MUTIL_EXPORT std::string safe_strerror(int err);

#endif  // MUTIL_SAFE_STRERROR_POSIX_H_
