...
#ifndef MUTIL_FILES_SCOPED_FILE_H_
#define MUTIL_FILES_SCOPED_FILE_H_
...
#if defined(OS_POSIX)
struct MUTIL_EXPORT ScopedFDCloseTraits {
...
// FD (like sockets).
//
// If you're writing low-level Windows code, see win/scoped_handle.h
// which provides some additional functionality.
//
// If you're writing cross-platform code that deals with actual files, you
// should generally use mutil::File instead which can be constructed with a
...
#endif  // MUTIL_FILES_SCOPED_FILE_H_
