...
// through mutil::i18n::WrapPathWithLTRFormatting() before displaying it in the
// RTL UI.
//
...
#ifndef MUTIL_FILES_FILE_PATH_H_
#define MUTIL_FILES_FILE_PATH_H_
...
class MUTIL_EXPORT FilePath {
 public:
  ...
  // long "extensions" to logic like mutil::GetUniquePathNumber().
  ...
  FilePath InsertBeforeExtensionASCII(
      const mutil::StringPiece& suffix) const WARN_UNUSED_RESULT;
  ...
  FilePath AppendASCII(const mutil::StringPiece& component)
...
MUTIL_EXPORT extern void PrintTo(const mutil::FilePath& path, std::ostream* out);
...
template<>
struct hash<mutil::FilePath> {
  size_t operator()(const mutil::FilePath& f) const {
    return hash<mutil::FilePath::StringType>()(f.value());
  }
};

#elif defined(COMPILER_MSVC)

inline size_t hash_value(const mutil::FilePath& f) {
...
#endif  // MUTIL_FILES_FILE_PATH_H_
