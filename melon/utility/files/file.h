...
class MUTIL_EXPORT File {
 ...
 public:
  ...
  // too, and the ParamTraits<mutil::PlatformFileInfo> implementation in
  // chrome/common/common_param_traits.cc.
  struct MUTIL_EXPORT Info {
    Info();
    ~Info();
#if defined(OS_POSIX)
    ...
    mutil::Time last_modified;

    // The last accessed time of a file.
    mutil::Time last_accessed;

    // The creation time of a file.
    mutil::Time creation_time;
  };
