...
#ifndef MUTIL_FILES_MEMORY_MAPPED_FILE_H_
#define MUTIL_FILES_MEMORY_MAPPED_FILE_H_
...
class MUTIL_EXPORT MemoryMappedFile {
 public:
...
#endif  // MUTIL_FILES_MEMORY_MAPPED_FILE_H_
