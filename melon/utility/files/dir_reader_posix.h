...
#if defined(OS_LINUX)
#include "melon/utility/files/dir_reader_linux.h"
#elif defined(__APPLE__)
#include "melon/utility/files/dir_reader_unix.h"
#else
#include "melon/utility/files/dir_reader_fallback.h"
#endif
...
#endif // MUTIL_FILES_DIR_READER_POSIX_H_
