...
#ifndef MUTIL_FILES_FILE_ENUMERATOR_H_
#define MUTIL_FILES_FILE_ENUMERATOR_H_
...
// Example:
//
//   mutil::FileEnumerator enum(my_dir, false, mutil::FileEnumerator::FILES,
//                             FILE_PATH_LITERAL("*.txt"));
//   for (mutil::FilePath name = enum.Next(); !name.empty(); name = enum.Next())
//     ...
class MUTIL_EXPORT FileEnumerator {
 public:
  // Note: copy & assign supported.
  class MUTIL_EXPORT FileInfo {
   public:
    FileInfo();
    ~FileInfo();
...
#endif  // MUTIL_FILES_FILE_ENUMERATOR_H_
