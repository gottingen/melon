...
// of hash_map. Allows all platforms to use |mutil::hash_map| and
// |mutil::hash_set|.
//  eg:
//   mutil::hash_map<int, std::string> my_map;
//   mutil::hash_set<int> my_set;
//
...
#ifndef MUTIL_CONTAINERS_HASH_TABLES_H_
#define MUTIL_CONTAINERS_HASH_TABLES_H_
...
#define MUTIL_HASH_NAMESPACE stdext

#elif defined(COMPILER_GCC)
#if defined(OS_ANDROID)
#define MUTIL_HASH_NAMESPACE std
#else
#define MUTIL_HASH_NAMESPACE __gnu_cxx
#endif
...
DEFINE_STRING_HASH(mutil::string16);
...
#else  // COMPILER
#error define MUTIL_HASH_NAMESPACE for your compiler
#endif  // COMPILER

namespace mutil {
using MUTIL_HASH_NAMESPACE::hash_map;
using MUTIL_HASH_NAMESPACE::hash_multimap;
using MUTIL_HASH_NAMESPACE::hash_multiset;
using MUTIL_HASH_NAMESPACE::hash_set;
...
inline std::size_t hash_value(const std::pair<Type1, Type2>& value) {
  return mutil::HashPair(value.first, value.second);
}
...
#endif  // MUTIL_CONTAINERS_HASH_TABLES_H_
