...
#ifndef MUTIL_CONTAINERS_MRU_CACHE_H_
#define MUTIL_CONTAINERS_MRU_CACHE_H_
...
struct MRUCacheHashMap {
  typedef mutil::hash_map<KeyType, ValueType> Type;
};

// This class is similar to MRUCache, except that it uses mutil::hash_map as
...
#endif  // MUTIL_CONTAINERS_MRU_CACHE_H_
