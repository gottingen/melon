...
#ifndef MUTIL_CONTAINERS_STACK_CONTAINER_H_
#define MUTIL_CONTAINERS_STACK_CONTAINER_H_
...
class StackAllocator : public std::allocator<T> {
 public:
  ...
  struct Source {
    ...
    mutil::AlignedMemory<sizeof(T[stack_capacity]), ALIGNOF(T)> stack_buffer_;
...
#endif  // MUTIL_CONTAINERS_STACK_CONTAINER_H_
