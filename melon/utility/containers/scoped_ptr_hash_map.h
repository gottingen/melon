...
#ifndef MUTIL_CONTAINERS_SCOPED_PTR_HASH_MAP_H_
#define MUTIL_CONTAINERS_SCOPED_PTR_HASH_MAP_H_
...
// mutil::hash_map. The ScopedPtrHashMap has ownership of all values in the data
// structure.
template <typename Key, typename Value>
class ScopedPtrHashMap {
  typedef mutil::hash_map<Key, Value*> Container;
...
#endif  // MUTIL_CONTAINERS_SCOPED_PTR_HASH_MAP_H_
