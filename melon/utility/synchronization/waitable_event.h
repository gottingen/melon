...
#ifndef MUTIL_SYNCHRONIZATION_WAITABLE_EVENT_H_
#define MUTIL_SYNCHRONIZATION_WAITABLE_EVENT_H_
...
class MUTIL_EXPORT WaitableEvent {
 public:
...
#endif  // MUTIL_SYNCHRONIZATION_WAITABLE_EVENT_H_
