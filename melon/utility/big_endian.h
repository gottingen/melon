...
#ifndef MUTIL_BIG_ENDIAN_H_
#define MUTIL_BIG_ENDIAN_H_
...
class MUTIL_EXPORT BigEndianReader {
 public:
  ...
  bool ReadPiece(mutil::StringPiece* out, size_t len);
...
class MUTIL_EXPORT BigEndianWriter {
 public:
