...
#ifndef MUTIL_OBSERVER_LIST_H__
#define MUTIL_OBSERVER_LIST_H__
...
class ObserverListBase
    : public mutil::SupportsWeakPtr<ObserverListBase<ObserverType> > {
 public:
  ...
  class Iterator {
   ...
   private:
    mutil::WeakPtr<ObserverListBase<ObserverType> > list_;
    size_t index_;
    size_t max_index_;
  };
