...
//      mutil::ThreadRestrictions::SetIOAllowed(false);
...
class MUTIL_EXPORT ThreadRestrictions {
 public:
  // Constructing a ScopedAllowIO temporarily allows IO for the current
  // thread.  Doing this is almost certainly always incorrect.
  class MUTIL_EXPORT ScopedAllowIO {
   public:
  ...
  class MUTIL_EXPORT ScopedAllowSingleton {
   public:
...
public:
  ...
  class MUTIL_EXPORT ScopedAllowWait {
   public:
...
#endif  // MUTIL_THREADING_THREAD_RESTRICTIONS_H_
