...
#ifndef MUTIL_THREADING_PLATFORM_THREAD_H_
#define MUTIL_THREADING_PLATFORM_THREAD_H_
...
class MUTIL_EXPORT PlatformThread {
 public:
  ...
  static void Sleep(mutil::TimeDelta duration);
...
#endif  // MUTIL_THREADING_PLATFORM_THREAD_H_
