...
#ifndef MUTIL_THREADING_THREAD_ID_NAME_MANAGER_H_
#define MUTIL_THREADING_THREAD_ID_NAME_MANAGER_H_
...
class MUTIL_EXPORT ThreadIdNameManager {
 public:
...
#endif  // MUTIL_THREADING_THREAD_ID_NAME_MANAGER_H_
