...
#ifndef MUTIL_THREADING_THREAD_LOCAL_STORAGE_H_
#define MUTIL_THREADING_THREAD_LOCAL_STORAGE_H_
...
class MUTIL_EXPORT PlatformThreadLocalStorage {
 public:
...
class MUTIL_EXPORT ThreadLocalStorage {
 public:
...
#define TLS_INITIALIZER {false, 0}
  ...
  struct MUTIL_EXPORT StaticSlot {
  ...
  class MUTIL_EXPORT Slot : public StaticSlot {
   public:
...
#endif  // MUTIL_THREADING_THREAD_LOCAL_STORAGE_H_
