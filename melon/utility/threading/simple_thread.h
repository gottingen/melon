...
#ifndef MUTIL_THREADING_SIMPLE_THREAD_H_
#define MUTIL_THREADING_SIMPLE_THREAD_H_
...
class MUTIL_EXPORT SimpleThread : public PlatformThread::Delegate {
 public:
  class MUTIL_EXPORT Options {
   public:
...
class MUTIL_EXPORT DelegateSimpleThread : public SimpleThread {
 public:
  class MUTIL_EXPORT Delegate {
   public:
    Delegate() { }
    virtual ~Delegate() { }
    virtual void Run() = 0;
...
class MUTIL_EXPORT DelegateSimpleThreadPool
 ...
 private:
  ...
  mutil::Lock lock_;            // Locks delegates_
  WaitableEvent dry_;    // Not signaled when there is no work to do.
};

}  // namespace mutil

#endif  // MUTIL_THREADING_SIMPLE_THREAD_H_
