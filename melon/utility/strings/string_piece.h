...
//
// StringPiece16 is similar to StringPiece but for mutil::string16 instead of
...
#ifndef MUTIL_STRINGS_STRING_PIECE_H_
#define MUTIL_STRINGS_STRING_PIECE_H_
...
// template internal to the .cc file.
    namespace internal {
        ...
        MUTIL_EXPORT void CopyToString(const StringPiece &self, std::string *target);

        MUTIL_EXPORT void CopyToString(const StringPiece16 &self, string16 *target);

        MUTIL_EXPORT void AppendToString(const StringPiece &self, std::string *target);

        MUTIL_EXPORT void AppendToString(const StringPiece16 &self, string16 *target);

        MUTIL_EXPORT size_t copy(const StringPiece &self,
                                 char *buf,
                                 size_t n,
                                 size_t pos);

        MUTIL_EXPORT size_t copy(const StringPiece16 &self,
                                 char16 *buf,
                                 size_t n,
                                 size_t pos);

        MUTIL_EXPORT size_t find(const StringPiece &self,
                                 const StringPiece &s,
                                 size_t pos);

        MUTIL_EXPORT size_t find(const StringPiece16 &self,
        ...
        MUTIL_EXPORT size_t rfind(const StringPiece &self,
                                  const StringPiece &s,
                                  size_t pos);

        MUTIL_EXPORT size_t rfind(const StringPiece16 &self,
                                  const StringPiece16 &s,
                                  size_t pos);
        ...
        MUTIL_EXPORT size_t find_first_of(const StringPiece &self,
                                          const StringPiece &s,
                                          size_t pos);

        MUTIL_EXPORT size_t find_first_of(const StringPiece16 &self,
                                          const StringPiece16 &s,
                                          size_t pos);

        MUTIL_EXPORT size_t find_first_not_of(const StringPiece &self,
                                              const StringPiece &s,
                                              size_t pos);

        MUTIL_EXPORT size_t find_first_not_of(const StringPiece16 &self,
                                              const StringPiece16 &s,
                                              size_t pos);
        ...
        MUTIL_EXPORT size_t find_last_of(const StringPiece &self,
                                         const StringPiece &s,
                                         size_t pos);

        MUTIL_EXPORT size_t find_last_of(const StringPiece16 &self,
                                         const StringPiece16 &s,
                                         size_t pos);
        ...
        MUTIL_EXPORT size_t find_last_not_of(const StringPiece &self,
                                             const StringPiece &s,
                                             size_t pos);

        MUTIL_EXPORT size_t find_last_not_of(const StringPiece16 &self,
                                             const StringPiece16 &s,
                                             size_t pos);
        ...
        MUTIL_EXPORT StringPiece substr(const StringPiece &self,
                                        size_t pos,
                                        size_t n);

        MUTIL_EXPORT StringPiece16 substr(const StringPiece16 &self,
                                          size_t pos,
                                          size_t n);
...
// BasicStringPiece<std::string> or BasicStringPiece<mutil::string16>.
    template<typename STRING_TYPE>
    class BasicStringPiece {
    public:
    ...
    public:
        ...
        BasicStringPiece(std::basic_string_view<value_type> str)
                : ptr_(str.data()), length_(str.size()) {}
...
// MSVC doesn't like complex extern templates and DLLs.
    ...
    extern template
    class MUTIL_EXPORT BasicStringPiece<std::string>;

    extern template
    class MUTIL_EXPORT BasicStringPiece<string16>;

#endif

// StringPiece operators --------------------------------------------------------

    MUTIL_EXPORT bool operator==(const StringPiece &x, const StringPiece &y);
...
// StringPiece16 operators -----------------------------------------------------
    ...
    MUTIL_EXPORT std::ostream &operator<<(std::ostream &o,
...
// This hash function is copied from containers/hash_tables.h. We don't
...
namespace MUTIL_HASH_NAMESPACE {
    ...
    template<>
    struct hash<mutil::StringPiece> {
        std::size_t operator()(const mutil::StringPiece &sp) const {
            HASH_STRING_PIECE(mutil::StringPiece, sp);
        }
    };

    template<>
    struct hash<mutil::StringPiece16> {
        std::size_t operator()(const mutil::StringPiece16 &sp16) const {
            HASH_STRING_PIECE(mutil::StringPiece16, sp16);
        }
    };

#elif defined(COMPILER_MSVC)

    inline size_t hash_value(const mutil::StringPiece& sp) {
      HASH_STRING_PIECE(mutil::StringPiece, sp);
    }
    inline size_t hash_value(const mutil::StringPiece16& sp16) {
      HASH_STRING_PIECE(mutil::StringPiece16, sp16);
    }
...
#endif  // MUTIL_STRINGS_STRING_PIECE_H_
