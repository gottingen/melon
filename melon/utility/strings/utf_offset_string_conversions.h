...
#ifndef MUTIL_STRINGS_UTF_OFFSET_STRING_CONVERSIONS_H_
#define MUTIL_STRINGS_UTF_OFFSET_STRING_CONVERSIONS_H_
...
class MUTIL_EXPORT OffsetAdjuster {
 public:
  struct MUTIL_EXPORT Adjustment {
...
// It may be NULL.
MUTIL_EXPORT bool UTF8ToUTF16WithAdjustments(
    const char* src,
    size_t src_len,
    string16* output,
    mutil::OffsetAdjuster::Adjustments* adjustments);
MUTIL_EXPORT string16 UTF8ToUTF16WithAdjustments(
    const mutil::StringPiece& utf8,
    mutil::OffsetAdjuster::Adjustments* adjustments);
...
MUTIL_EXPORT string16 UTF8ToUTF16AndAdjustOffsets(
    const mutil::StringPiece& utf8,
    std::vector<size_t>* offsets_for_adjustment);

MUTIL_EXPORT std::string UTF16ToUTF8AndAdjustOffsets(
    const mutil::StringPiece16& utf16,
    std::vector<size_t>* offsets_for_adjustment);
...
#endif  // MUTIL_STRINGS_UTF_OFFSET_STRING_CONVERSIONS_H_
