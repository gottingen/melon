...
// Basic example:
//   char buf[20];
//   mutil::strings::SafeSPrintf(buf, "The answer: %2d", 42);
//
...
MUTIL_EXPORT ssize_t SafeSNPrintf(char* buf, size_t sz, const char* fmt,
...
MUTIL_EXPORT void SetSafeSPrintfSSizeMaxForTest(size_t max);
MUTIL_EXPORT size_t GetSafeSPrintfSSizeMaxForTest();
#endif
...
MUTIL_EXPORT ssize_t SafeSNPrintf(char* buf, size_t N, const char* fmt);
template<size_t N>
...
#endif  // MUTIL_STRINGS_SAFE_SPRINTF_H_
