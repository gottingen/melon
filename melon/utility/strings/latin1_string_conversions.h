...
#ifndef MUTIL_STRINGS_LATIN1_STRING_CONVERSIONS_H_
#define MUTIL_STRINGS_LATIN1_STRING_CONVERSIONS_H_
...
MUTIL_EXPORT string16 Latin1OrUTF16ToUTF16(size_t length,
                                          const Latin1Char* latin1,
                                          const char16* utf16);

}  // namespace mutil

#endif  // MUTIL_STRINGS_LATIN1_STRING_CONVERSIONS_H_
