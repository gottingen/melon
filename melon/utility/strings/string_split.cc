...
bool SplitStringIntoKeyValuePairs(const mutil::StringPiece& line,
                                  char key_value_delimiter,
                                  char key_value_pair_delimiter,
...
void SplitStringUsingSubstr(const mutil::StringPiece16& str,
...
void SplitStringUsingSubstr(const mutil::StringPiece& str,
...
void SplitStringAlongWhitespace(const mutil::StringPiece16& str,
...
void SplitStringAlongWhitespace(const mutil::StringPiece& str,
