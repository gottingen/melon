...
#ifndef MUTIL_STRINGS_STRING_TOKENIZER_H_
#define MUTIL_STRINGS_STRING_TOKENIZER_H_
...
class StringTokenizerT {
 public:
  ...
  mutil::StringPiece token_piece() const {
    return mutil::StringPiece(&*token_begin_,
...
#endif  // MUTIL_STRINGS_STRING_TOKENIZER_H_
