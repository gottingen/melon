...
inline bool operator==(const mutil::IOBuf& b, const mutil::StringPiece& s)
{ return b.equals(s); }
inline bool operator==(const mutil::StringPiece& s, const mutil::IOBuf& b)
{ return b.equals(s); }
inline bool operator!=(const mutil::IOBuf& b, const mutil::StringPiece& s)
{ return !b.equals(s); }
inline bool operator!=(const mutil::StringPiece& s, const mutil::IOBuf& b)
{ return !b.equals(s); }
inline bool operator==(const mutil::IOBuf& b1, const mutil::IOBuf& b2)
{ return b1.equals(b2); }
inline bool operator!=(const mutil::IOBuf& b1, const mutil::IOBuf& b2)
{ return !b1.equals(b2); }
