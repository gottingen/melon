...
#ifndef MUTIL_DEBUG_STACK_TRACE_H_
#define MUTIL_DEBUG_STACK_TRACE_H_
...
MUTIL_EXPORT bool EnableInProcessStackDumping();
...
MUTIL_EXPORT bool EnableInProcessStackDumpingForSandbox();

// A stacktrace can be helpful in debugging. For example, you can include a
// stacktrace member in a object (probably around #ifndef NDEBUG) so that you
// can later see where the given object was created from.
class MUTIL_EXPORT StackTrace {
 public:
...
// appended.
MUTIL_EXPORT char *itoa_r(intptr_t i,
                         char *buf,
                         size_t sz,
                         int base,
                         size_t padding);
...
#endif  // MUTIL_DEBUG_STACK_TRACE_H_
