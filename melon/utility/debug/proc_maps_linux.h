...
#ifndef MUTIL_DEBUG_PROC_MAPS_LINUX_H_
#define MUTIL_DEBUG_PROC_MAPS_LINUX_H_
...
MUTIL_EXPORT bool ReadProcMaps(std::string* proc_maps);

// Parses /proc/<pid>/maps input data and stores in |regions|. Returns true
// and updates |regions| if and only if all of |input| was successfully parsed.
MUTIL_EXPORT bool ParseProcMaps(const std::string& input,
                               std::vector<MappedMemoryRegion>* regions);

}  // namespace debug
}  // namespace mutil

#endif  // MUTIL_DEBUG_PROC_MAPS_LINUX_H_
