...
void DemangleSymbols(std::string* text) {
  ...
  while (search_from < text->size()) {
    ...
    int status = 0;
    scoped_ptr<char, mutil::FreeDeleter> demangled_symbol(
...
void WarmUpBacktrace() {
  ...
  // #20 0x0000000000752a54 in mutil::debug::StackTrace::StackTrace
  //             at debug/stack_trace_posix.cc:175
  // #21 0x00000000007a4ae5 in
  //             mutil::(anonymous namespace)::StackDumpSignalHandler
  //             at process_util_posix.cc:172
...
StackTrace::StackTrace() {
  ...
  if (GetStackTrace) {
      ...
      count_ = mutil::saturated_cast<size_t>(backtrace(trace_, arraysize(trace_)));
#else
      count_ = 0;
#endif
  }
