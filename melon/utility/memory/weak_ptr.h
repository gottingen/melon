...
class MUTIL_EXPORT WeakReference {
 public:
  // Although Flag is bound to a specific thread, it may be deleted from another
  // via mutil::WeakPtr::~WeakPtr().
  class MUTIL_EXPORT Flag : public RefCountedThreadSafe<Flag> {
   public:
    Flag();
   ...
   private:
    friend class mutil::RefCountedThreadSafe<Flag>;
...
class MUTIL_EXPORT WeakReferenceOwner {
 public:
  WeakReferenceOwner();
  ~WeakReferenceOwner();
...
class MUTIL_EXPORT WeakPtrBase {
 public:
  WeakPtrBase();
  ~WeakPtrBase();
...
class SupportsWeakPtrBase {
 public:
  ...
  // from SupportsWeakPtr<Base>. See mutil::AsWeakPtr() below for a helper
  ...
  static WeakPtr<Derived> StaticAsWeakPtr(Derived* t) {
    typedef
      ...
      static_assert(convertible::value,
                   "AsWeakPtr argument inherits from SupportsWeakPtr");
...
//
// EXAMPLE:
//   class Base : public mutil::SupportsWeakPtr<Producer> {};
//   class Derived : public Base {};
//
//   Derived derived;
//   mutil::WeakPtr<Derived> ptr = mutil::AsWeakPtr(&derived);
//
...
// the caller.
//
//   mutil::WeakPtr<Derived> ptr = derived.AsWeakPtr();  // Fails.
...
#endif  // MUTIL_MEMORY_WEAK_PTR_H_
