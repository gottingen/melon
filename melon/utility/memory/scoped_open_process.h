...
#ifndef MUTIL_MEMORY_SCOPED_OPEN_PROCESS_H_
#define MUTIL_MEMORY_SCOPED_OPEN_PROCESS_H_

#include "melon/utility/process/process_handle.h"
...
#endif  // MUTIL_MEMORY_SCOPED_OPEN_PROCESS_H_
