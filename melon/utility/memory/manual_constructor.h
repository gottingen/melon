...
//
// For example usage, check out containers/small_map.h.

#ifndef MUTIL_MEMORY_MANUAL_CONSTRUCTOR_H_
#define MUTIL_MEMORY_MANUAL_CONSTRUCTOR_H_
...
#endif  // MUTIL_MEMORY_MANUAL_CONSTRUCTOR_H_
