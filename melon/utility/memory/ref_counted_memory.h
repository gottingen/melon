...
#ifndef MUTIL_MEMORY_REF_COUNTED_MEMORY_H_
#define MUTIL_MEMORY_REF_COUNTED_MEMORY_H_
...
class MUTIL_EXPORT RefCountedMemory
    : public mutil::RefCountedThreadSafe<RefCountedMemory> {
 public:
 ...
 protected:
  friend class mutil::RefCountedThreadSafe<RefCountedMemory>;
  RefCountedMemory();
...
// matter.
class MUTIL_EXPORT RefCountedStaticMemory : public RefCountedMemory {
 public:
...
class MUTIL_EXPORT RefCountedBytes : public RefCountedMemory {
 public:
  RefCountedBytes();
...
class MUTIL_EXPORT RefCountedString : public RefCountedMemory {
 public:
  RefCountedString();
...
// using free().
class MUTIL_EXPORT RefCountedMallocedMemory : public mutil::RefCountedMemory {
 public:
...
#endif  // MUTIL_MEMORY_REF_COUNTED_MEMORY_H_
