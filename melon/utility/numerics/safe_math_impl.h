...
#define MUTIL_FLOAT_ARITHMETIC_STUBS(NAME)                        \
  template <typename T>                                          \
...
MUTIL_FLOAT_ARITHMETIC_STUBS(Add)
MUTIL_FLOAT_ARITHMETIC_STUBS(Sub)
MUTIL_FLOAT_ARITHMETIC_STUBS(Mul)
MUTIL_FLOAT_ARITHMETIC_STUBS(Div)
MUTIL_FLOAT_ARITHMETIC_STUBS(Mod)

#undef MUTIL_FLOAT_ARITHMETIC_STUBS
