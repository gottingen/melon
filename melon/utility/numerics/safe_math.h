...
#ifndef MUTIL_SAFE_MATH_H_
#define MUTIL_SAFE_MATH_H_

#include "melon/utility/numerics/safe_math_impl.h"
...
class CheckedNumeric {
 public:
  ...
  T ValueFloating() const {
      static_assert(std::numeric_limits<T>::is_iec559, "argument_must_be_float");
...
#define MUTIL_NUMERIC_ARITHMETIC_OPERATORS(NAME, OP, COMPOUND_OP)              \
...
MUTIL_NUMERIC_ARITHMETIC_OPERATORS(Add, +, += )
MUTIL_NUMERIC_ARITHMETIC_OPERATORS(Sub, -, -= )
MUTIL_NUMERIC_ARITHMETIC_OPERATORS(Mul, *, *= )
MUTIL_NUMERIC_ARITHMETIC_OPERATORS(Div, /, /= )
MUTIL_NUMERIC_ARITHMETIC_OPERATORS(Mod, %, %= )

#undef MUTIL_NUMERIC_ARITHMETIC_OPERATORS
