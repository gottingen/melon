...
#ifndef MUTIL_LAZY_INSTANCE_H_
#define MUTIL_LAZY_INSTANCE_H_
...
// mutil::LazyInstance<T>::Leaky my_leaky_lazy_instance;
// instead of:
// mutil::LazyInstance<T, mutil::internal::LeakyLazyInstanceTraits<T> >
...
// return false.
MUTIL_EXPORT bool NeedsLazyInstance(subtle::AtomicWord* state);

// After creating an instance, call this to register the dtor to be called
// at program exit and to update the atomic state to hold the |new_instance|
MUTIL_EXPORT void CompleteLazyInstance(subtle::AtomicWord* state,
...
class LazyInstance {
 public:
  ...
  mutil::AlignedMemory<sizeof(Type), ALIGNOF(Type)> private_buf_;
