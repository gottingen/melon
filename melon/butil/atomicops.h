...
#include "melon/butil/atomicops_internals_tsan.h"
#elif defined(OS_WIN) && defined(COMPILER_MSVC) && defined(ARCH_CPU_X86_FAMILY)
#include "melon/butil/atomicops_internals_x86_msvc.h"
#elif defined(OS_MACOSX)
#include "melon/butil/atomicops_internals_mac.h"
#elif defined(OS_NACL)
#include "melon/butil/atomicops_internals_gcc.h"
#elif defined(COMPILER_GCC) && defined(ARCH_CPU_ARMEL)
#include "melon/butil/atomicops_internals_arm_gcc.h"
#elif defined(COMPILER_GCC) && defined(ARCH_CPU_ARM64)
#include "melon/butil/atomicops_internals_arm64_gcc.h"
#elif defined(COMPILER_GCC) && defined(ARCH_CPU_X86_FAMILY)
#include "melon/butil/atomicops_internals_x86_gcc.h"
#elif defined(COMPILER_GCC) && defined(ARCH_CPU_MIPS_FAMILY)
#include "melon/butil/atomicops_internals_mips_gcc.h"
#elif defined(COMPILER_GCC) && defined(ARCH_CPU_LOONGARCH64_FAMILY)
#include "melon/butil/atomicops_internals_loongarch64_gcc.h"
#else
...
#include "melon/butil/atomicops_internals_atomicword_compat.h"
#endif
