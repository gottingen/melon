...
namespace melon {
    ...
    result_status sysinfo::get_proc_cpu(melon_pid_t pid, proc_cpu_info &proccpu) {
        const auto time_now = melon::time_now().to_unix_millis();
        proc_cpu_info prev = {};
...
#if defined MELON_PLATFORM_LINUX || defined MELON_PLATFORM_OSX
#ifndef __NR_gettid
...
#endif  // MELON_PLATFORM_LINUX || MELON_PLATFORM_OSX
...
#if defined(MELON_INTERNAL_UNSCALED_CYCLECLOCK_FREQUENCY_IS_CPU_FREQUENCY)
...
#endif  // MELON_INTERNAL_UNSCALED_CYCLECLOCK_FREQUENCY_IS_CPU_FREQUENCY
