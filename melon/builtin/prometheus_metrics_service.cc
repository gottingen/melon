...
namespace melon {
    ...
    private:
        ...
        turbo::flat_hash_map<std::string, SummaryItems> _m;
    };
    ...
    PrometheusMetricsDumper::ProcessLatencyRecorderSuffix(const std::string_view &name,
        ...
        static std::string latency_names[] = {
                turbo::str_format("_latency_%d", (int) melon::var::FLAGS_var_latency_p1),
                turbo::str_format("_latency_%d", (int) melon::var::FLAGS_var_latency_p2),
                turbo::str_format("_latency_%d", (int) melon::var::FLAGS_var_latency_p3),
        ...
        for (int i = 0; i < NPERCENTILES; ++i) {
            ...
            SummaryItems *si = &_m[metric_name];
            ...
            if (i == NPERCENTILES - 1) {
                ...
                si->metric_name.assign(metric_name.data(), metric_name.size());
            }
            return si;
        }
