...
// ucontext_t on non-POSIX systems.
        void *GetProgramCounter(void *vuc) {
            ...
            if (vuc != nullptr) {
              ...
              if (14 < MELON_ARRAY_SIZE(context->uc_mcontext.gregs))
              ...
              if (16 < MELON_ARRAY_SIZE(context->uc_mcontext.gregs))
...
// appropriate.
        static void DumpPCAndFrameSizeAndSymbol(void (*writerfn)(const char *, void *),
            ...
            if (melon::debugging::symbolize(symbolize_pc, tmp, sizeof(tmp))) {
                symbol = tmp;
            }
            char buf[1024];
            if (framesize <= 0) {
        ...
        void DumpPCAndFrameSizesAndStackTrace(
            ...
            for (int i = 0; i < depth; i++) {
                if (symbolize_stacktrace) {
                    ...
                    // call to a function annotated noreturn (e.g. MELON_CHECK). Note that we don't
