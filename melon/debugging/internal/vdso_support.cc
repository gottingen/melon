...
#ifdef MELON_HAVE_VDSO_SUPPORT     // defined in vdso_support.h
...
const void *VDSOSupport::SetBase(const void *base) {
  MELON_CHECK(base != debugging_internal::ElfMemImage::kInvalidBase)<<"internal error";
...
long VDSOSupport::InitAndGetCPU(unsigned *cpu,  // NOLINT(runtime/int)
  ...
  MELON_CHECK(fn != &InitAndGetCPU)<< "Init() did not set getcpu_fn_";
  return (*fn)(cpu, x, y);
}
