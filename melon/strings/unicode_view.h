...
#ifndef MELON_STRINGS_UNICODE_VIEW_H_
#define MELON_STRINGS_UNICODE_VIEW_H_
...
namespace melon {
    ...
    public:
        ...
        constexpr const_reference operator[](size_type i) const noexcept {
            return MELON_CHECK(i < size()), ptr_[i];
        }
        ...
        constexpr const_reference at(size_type i) const {
            return MELON_LIKELY(i < size()) ? ptr_[i] : throw std::out_of_range("unicode_view::at"),
                    ptr_[i];
        }
        ...
        constexpr const_reference front() const noexcept {
            return MELON_CHECK(!empty()), ptr_[0];
        }
        ...
        constexpr const_reference back() const noexcept {
            return MELON_CHECK(!empty()), ptr_[size() - 1];
        }
        ...
        unicode_view substr(size_type pos, size_type n = npos) const {
            return MELON_UNLIKELY(pos > length_)
    ...
    */
    ...
    inline unicode_view clipped_substr(unicode_view s, size_t pos, size_t n = unicode_view::npos) {
...
#endif  // MELON_STRINGS_UNICODE_VIEW_H_
