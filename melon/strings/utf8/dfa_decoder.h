...
#ifndef MELON_STRINGS_UTF8_DFA_DECODER_H_
#define MELON_STRINGS_UTF8_DFA_DECODER_H_
...
namespace melon::utf8_detail {
    ...
    //
    template<int32_t size>
    MELON_FORCE_INLINE void dfa_decoder::advance_with_table(char8_t const *&pSrc,
                                                         int32_t curr,
                                                         char32_t &cdpt) noexcept {
...
#pragma unroll(size)
    ...
    MELON_FORCE_INLINE void dfa_decoder::advance_with_table_2(const char8_t *&pSrc,
                                                           int32_t curr,
                                                           char32_t &cdpt) noexcept {
    ...
    MELON_FORCE_INLINE void dfa_decoder::advance_with_table_3(const char8_t *&pSrc,
                                                           int32_t curr,
                                                           char32_t &cdpt) noexcept {
        char32_t unit2;  //- The second UTF-8 code unit
    ...
    MELON_FORCE_INLINE void dfa_decoder::advance_with_table_4(const char8_t *&pSrc,
                                                           int32_t curr,
                                                           char32_t &cdpt) noexcept {
        char32_t unit2;  //- The second UTF-8 code unit
        char32_t unit3;  //- The third UTF-8 code unit
    ...
    //--------------------------------------------------------------------------------------------------
    //
    MELON_FORCE_INLINE dfa_decoder::dfa_state
...
#endif  // MELON_STRINGS_UTF8_DFA_DECODER_H_
