...
// -----------------------------------------------------------------------------
//
// This file defines `melon::string_replace_all()`, a general-purpose string
...
// vary, `melon::Substitute()` may be a better choice.
//
// Example:
//
// std::string html_escaped = melon::string_replace_all(user_input, {
//                                                {"&", "&amp;"},
//                                                {"<", "&lt;"},
//                                                {">", "&gt;"},
//                                                {"\"", "&quot;"},
//                                                {"'", "&#39;"}});
#ifndef MELON_STRINGS_STR_REPLACE_H_
#define MELON_STRINGS_STR_REPLACE_H_
...
// Example:
//
//   std::string s = melon::string_replace_all(
//       "$who bought $count #Noun. Thanks $who!",
//       {{"$count", melon::string_cat(5)},
//        {"$who", "Bob"},
//        {"#Noun", "Apples"}});
//   EXPECT_EQ("Bob bought 5 Apples. Thanks Bob!", s);
MELON_MUST_USE_RESULT std::string string_replace_all(
        std::string_view s,
...
//   replacements.push_back({"<", "&lt;"});
//   replacements.push_back({">", "&gt;"});
//   std::string s = melon::string_replace_all("if (ptr < &foo)",
//                                  replacements);
...
//   int count = melon::string_replace_all({{"&", "&amp;"},
//                                    {"<", "&lt;"},
//                                    {">", "&gt;"}}, &s);
//  EXPECT_EQ(count, 2);
//  EXPECT_EQ("if (ptr &lt; &amp;foo)", s);
...
#endif  // MELON_STRINGS_STR_REPLACE_H_
