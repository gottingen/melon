...
#ifndef MELON_STRINGS_INTERNAL_CHARCONV_PARSE_H_
#define MELON_STRINGS_INTERNAL_CHARCONV_PARSE_H_
...
// The decomposed parts of a parsed `float` or `double`.
        ...
        ParsedFloat ParseFloat(const char *begin, const char *end,
                               melon::chars_format format_flags);
...
#endif  // MELON_STRINGS_INTERNAL_CHARCONV_PARSE_H_
