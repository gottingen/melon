...
// melon/strings/str_join.h
//

#ifndef MELON_STRINGS_INTERNAL_STR_JOIN_INTERNAL_H_
#define MELON_STRINGS_INTERNAL_STR_JOIN_INTERNAL_H_
...
namespace melon::strings_internal {
    ...
    std::string join_algorithm(Iterator start, Iterator end, std::string_view s,
        ...
        if (start != end) {
            ...
            if (result_size > 0) {
                melon::base::string_resize_uninitialized(&result, result_size);
...
#endif  // MELON_STRINGS_INTERNAL_STR_JOIN_INTERNAL_H_
