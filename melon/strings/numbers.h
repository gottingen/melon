...
#ifndef MELON_STRINGS_NUMBERS_H_
#define MELON_STRINGS_NUMBERS_H_
...
namespace melon {
    ...
    namespace numbers_internal {
        ...
        bool safe_strtou128_base(std::string_view text, melon::uint128 *value,
                                 int base);
        ...
        auto *hex = &melon::numbers_internal::kHexTable[byte * 2];
        std::memcpy(out
        + 2 * i, hex, 2);
    }
#endif
    ...
    return 16 -
    melon::base::countl_zero(val| 0x1) / 4;
}
...
#endif  // MELON_STRINGS_NUMBERS_H_
