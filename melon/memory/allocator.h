...
#ifndef MELON_MEMORY_ALLOCATOR_H_
#define MELON_MEMORY_ALLOCATOR_H_
...
///////////////////////////////////////////////////////////////////////////////
    ...
    void tracked_allocator::free(const allocation &allocation) {
        {
            ...
            MELON_CHECK(usageStats.count > 0)<<"tracked_allocator detected abnormal free()";
            MELON_CHECK(usageStats.bytes >= allocation.request.size)<<"tracked_allocator detected abnormal free()";
            --usageStats.count;
    ...
    // stl_allocator exposes an STL-compatible allocator wrapping a melon::allocator.
    template<typename T>
    struct stl_allocator {
        using value_type = T;
        using pointer = T *;
...
#endif  // MELON_MEMORY_ALLOCATOR_H_
