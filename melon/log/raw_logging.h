...
// The following MELON_STRIP_LOG testing is performed in the header file so that it's
...
#define MELON_RAW_DCHECK(condition, message) \
  while (false) \
    ...
    // building with MELON_STRIP_LOG > 0.
