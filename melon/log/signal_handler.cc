...
// Dumps information about the stack frame to STDERR.
        void DumpStackFrameInfo(const char *prefix, void *pc) {
            ...
            // next function.
            if (melon::debugging::symbolize(reinterpret_cast<char *>(pc) - 1,
...
// Invoke the default signal handler.
        ...
        void FailureSignalHandler(int signal_number,
            ...
            const int depth = melon::debugging::get_stack_trace(stack, MELON_ARRAY_SIZE(stack), 1);
# ifdef HAVE_SIGACTION
...
# endif
            ...
            // (See WARNING above.)
            //
            // AFTER this point, we do unsafe things, like using MELON_LOG()!
