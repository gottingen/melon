...
//
// melon::LatencyRecorder
//     g_mutex_contention("my_mutex_contention");
//                       // ^^^
//                       // you can replace this with a meaningful name
//
// typedef ::melon::MutexWithLatencyRecorder<pthread_mutex_t> my_mutex_t;
//                                       // ^^^
...
namespace std {
    ...
    template<typename Mutex>
    class lock_guard<melon::MutexWithRecorder<Mutex> >
            : public ::melon::metrics_internal::
            LockGuardBase<::melon::MutexWithRecorder<Mutex> > {
    public:
        typedef ::melon::metrics_internal::
        LockGuardBase<melon::MutexWithRecorder<Mutex> > Base;

        explicit lock_guard(::melon::MutexWithRecorder<Mutex> &mutex)
                : Base(mutex) {}
    };

    template<typename Mutex>
    class lock_guard<melon::MutexWithLatencyRecorder<Mutex> >
            : public ::melon::metrics_internal::
            LockGuardBase<::melon::MutexWithLatencyRecorder<Mutex> > {
    public:
        typedef ::melon::metrics_internal::
        LockGuardBase<melon::MutexWithLatencyRecorder<Mutex> > Base;

        explicit lock_guard(::melon::MutexWithLatencyRecorder<Mutex> &mutex)
                : Base(mutex) {}
    };

    template<typename Mutex>
    class unique_lock<melon::MutexWithRecorder<Mutex> >
            : public ::melon::metrics_internal::
            UniqueLockBase<::melon::MutexWithRecorder<Mutex> > {
    public:
        typedef ::melon::metrics_internal::
        UniqueLockBase<::melon::MutexWithRecorder<Mutex> > Base;
    ...
    template<typename Mutex>
    class unique_lock<melon::MutexWithLatencyRecorder<Mutex> >
            : public ::melon::metrics_internal::
            UniqueLockBase<::melon::MutexWithLatencyRecorder<Mutex> > {
    public:
        typedef ::melon::metrics_internal::
        UniqueLockBase<::melon::MutexWithLatencyRecorder<Mutex> > Base;
        typedef typename Base::mutex_type mutex_type;
...
#endif  // MELON_VARIABLE_LOCK_TIMER_H_
