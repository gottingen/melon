...
namespace melon::thread_internal {
    ...
    namespace {
        ...
        void *create_one_byte_dummy_page() {
            ...
            MELON_CHECK(ptr) << "Cannot create dummy page for asymmetric memory barrier.";
            (void) mlock(ptr, 1);
            return ptr;
        }
