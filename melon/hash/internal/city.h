...
#ifndef MELON_HASH_INTERNAL_CITY_H_
#define MELON_HASH_INTERNAL_CITY_H_
...
namespace melon::hash_internal {
    ...
    MELON_FORCE_INLINE uint64_t uint128_low64(const uint128 &x) { return x.first; }

    MELON_FORCE_INLINE uint64_t uint128_high64(const uint128 &x) { return x.second; }
    ...
    MELON_FORCE_INLINE uint64_t hash128_to_64(const uint128 &x) {
...
#endif  // MELON_HASH_INTERNAL_CITY_H_
