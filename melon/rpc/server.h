...
#ifndef MELON_RPC_SERVER_H_
#define MELON_RPC_SERVER_H_
...
struct ServerOptions {
    ...
    // Adaptor for Mongo protocol, check src/melon/mongo_service_adaptor.h for details
    ...
    // melon automatically schedules "io" and "worker" code for better
    ...
    // concurrency. However melon runs requests in fibers which are
...
struct ServiceOptions {
    ...
    // Services that use older versions of melon may need to turn this
