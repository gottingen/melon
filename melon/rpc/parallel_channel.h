...
#ifndef MELON_RPC_PARALLEL_CHANNEL_H_
#define MELON_RPC_PARALLEL_CHANNEL_H_
...
namespace melon::rpc {
    ...
    struct SubCall {
        SubCall(const google::protobuf::MethodDescriptor *method2,
                ...
                int flags2)
                : method(method2), request(request2), response(response2), flags(flags2) {}
    ...
    //   FooRequest* copied_req = melon::rpc::Clone<FooRequest>(request);
    //   copied_req->set_xxx(...);
    ...
    public:
        ...
        // melon::rpc::OWNS_CHANNEL, it will be deleted for only once.
...
#endif  // MELON_RPC_PARALLEL_CHANNEL_H_
