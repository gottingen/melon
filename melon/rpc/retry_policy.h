...
namespace melon::rpc {
    ...
    public:
        ...
        // as follows:
        //
        //   class MyRetryPolicy : public melon::rpc::RetryPolicy {
        //   public:
        //     bool DoRetry(const melon::rpc::Controller* cntl) const {
        //       if (cntl->ErrorCode() == 0) { // don't retry successful RPC
        //         return false;
        //       }
        //       if (cntl->ErrorCode() == melon::rpc::EHTTP && // http errors
        //           cntl->http_response().status_code() == melon::rpc::HTTP_STATUS_FORBIDDEN) {
        //         return true;
        //       }
        //       // Leave other cases to default.
        //       return melon::rpc::DefaultRetryPolicy()->DoRetry(cntl);
        //     }
        //   };
        //
