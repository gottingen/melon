...
#ifndef MELON_RPC_SOCKET_MESSAGE_H_
#define MELON_RPC_SOCKET_MESSAGE_H_

#include "melon/base/result_status.h"                          // melon::result_status


namespace melon::rpc {

    // Generate the cord_buf to write dynamically, for implementing complex protocols.
    ...
    public:
        ...
        virtual melon::result_status AppendAndDestroySelf(melon::cord_buf *out, Socket *sock) = 0;
...
#endif  // MELON_RPC_SOCKET_MESSAGE_H_
