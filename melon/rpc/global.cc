...
namespace melon::rpc {
    ...
    MELON_RPC_VALIDATE_GFLAG(free_memory_to_system_interval, PassValidate);
    ...
    struct GlobalExtensions {
        GlobalExtensions()
                : dns(80), dns_with_ssl(443), ch_mh_lb(CONS_HASH_LB_MURMUR3), ch_md5_lb(CONS_HASH_LB_MD5),
                  ch_ketama_lb(CONS_HASH_LB_KETAMA), constant_cl(0) {
        }
...
// Update global stuff periodically.
    ...
    static void GlobalInitializeOrDieImpl() {
        ...
        SetLogHandler(&melon_streaming_log_handler);
