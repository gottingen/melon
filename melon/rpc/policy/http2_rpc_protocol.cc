...
namespace melon::rpc {
    ...
    namespace policy {
        ...
        MELON_RPC_VALIDATE_GFLAG(h2_client_stream_window_size, CheckStreamWindowSize);

        static bool CheckConnWindowSize(const char *, int32_t val) {
            return val >= (int32_t) H2Settings::DEFAULT_INITIAL_WINDOW_SIZE;
        }

        MELON_RPC_VALIDATE_GFLAG(h2_client_connection_window_size, CheckConnWindowSize);
...
#define H2_CONNECTION_PREFACE_PREFIX "PRI * HTTP/2.0\r\n\r\nSM\r\n\r\n"
        ...
        melon::counter<int64_t> g_parse_time;
        melon::per_second<melon::counter<int64_t> > g_parse_time_per_second(
...
#if defined(MELON_RPC_PROFILE_H2)
        melon::counter<int64_t> g_append_request_time;
        melon::per_second<melon::counter<int64_t> > g_append_request_time_per_second(
...
#if defined(MELON_RPC_PROFILE_H2)
        melon::counter<int64_t> g_append_response_time;
        melon::per_second<melon::counter<int64_t> > g_append_response_time_per_second(
