...
#ifndef MELON_RPC_POLICY_RTMP_PROTOCOL_H_
...
#define RTMP_INFO_LEVEL_WARNING              "warning"
        ...
        struct RtmpMessageHeader {
            ...
            RtmpMessageHeader()
                    : timestamp(0), message_length(0), message_type(0), stream_id(RTMP_CONTROL_MESSAGE_STREAM_ID) {
            }
...
#endif  // MELON_RPC_POLICY_RTMP_PROTOCOL_H_
