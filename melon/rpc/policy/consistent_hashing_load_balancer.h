...
#ifndef  MELON_RPC_CONSISTENT_HASHING_LOAD_BALANCER_H_
#define  MELON_RPC_CONSISTENT_HASHING_LOAD_BALANCER_H_
    ...
    namespace policy {
        ...
        public:
            struct Node {
                ...
                melon::base::end_point server_addr;  // To make sorting stable among all clients
        ...
        private:
            ...
            void GetLoads(std::map<melon::base::end_point, double> *load_map);
...
#endif  // MELON_RPC_CONSISTENT_HASHING_LOAD_BALANCER_H_
