...
#ifndef MELON_RPC_POLICY_DISCOVERY_NAMING_SERVICE_H_
#define MELON_RPC_POLICY_DISCOVERY_NAMING_SERVICE_H_
...
namespace melon::rpc {
    namespace policy {
        ...
        private:
            ...
            turbo::end_point _current_discovery_server;
        };
...
#endif // MELON_RPC_POLICY_DISCOVERY_NAMING_SERVICE_H_
