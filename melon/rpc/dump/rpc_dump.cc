...
#define DUMPED_FILE_PREFIX "requests"
    ...
    MELON_VALIDATE_GFLAG(rpc_dump, PassValidate);
    MELON_VALIDATE_GFLAG(rpc_dump_max_requests_in_one_file, PositiveInteger);
    MELON_VALIDATE_GFLAG(rpc_dump_max_files, PositiveInteger);
...
// Dump a request.
    void RpcDumpContext::Dump(size_t round, SampledRequest *sample) {
        ...
        if (_cur_fd < 0) {
            ...
            _cur_filename = turbo::str_format("%s/" DUMPED_FILE_PREFIX ".%s_%06u",
