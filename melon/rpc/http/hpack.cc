...
#include <melon/base/containers/case_ignored_flat_map.h>      // mutil::FlatMap
...
namespace melon {
    ...
    public:
        IndexTable()
                : _start_index(0), _add_times(0), _size(0) {}
    ...
    public:
        ...
        // FIXME: resizing of out is costly
                : _out(out), _tree(tree), _cur_node(tree->node(HuffmanTree::ROOT_NODE)),
