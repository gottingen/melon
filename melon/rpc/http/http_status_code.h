...
#ifndef  MELON_RPC_HTTP_HTTP_STATUS_CODE_H_
#define  MELON_RPC_HTTP_HTTP_STATUS_CODE_H_
...
// Convert melon error code to related status code.
...
#endif  //MELON_RPC_HTTP_HTTP_STATUS_CODE_H_
