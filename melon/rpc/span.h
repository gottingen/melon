...
namespace melon::fiber_internal {
    extern thread_local melon::fiber_internal::fiber_local_storage tls_bls;
}
...
namespace melon::rpc {
    ...
    class Span : public melon::Collected {
        friend class SpanDB;
    ...
    public:
        ...
        // Set tls parent.
        void AsParent() {
            melon::fiber_internal::tls_bls.rpcz_parent_span = this;
        }
        ...
        static Span *tls_parent() {
            return (Span *) melon::fiber_internal::tls_bls.rpcz_parent_span;
        }
    ...
    private:
        ...
        melon::CollectorSpeedLimit *speed_limit();

        melon::CollectorPreprocessor *preprocessor();
...
// true.
    ...
    inline bool IsTraceable(bool is_upstream_traced) {
        extern melon::CollectorSpeedLimit g_span_sl;
        return is_upstream_traced ||
               (FLAGS_enable_rpcz && melon::is_collectable(&g_span_sl));
    }
