...
namespace melon::rpc {
    ...
    MELON_RPC_VALIDATE_GFLAG(max_profiling_seconds, NonNegativeInteger);

    DEFINE_int32(max_profiles_kept, 32,
                 "max profiles kept for cpu/heap/growth/contention respectively");
    MELON_RPC_VALIDATE_GFLAG(max_profiles_kept, PassValidate);
...
// This function is always called with g_env[type].mutex UNLOCKED.
    ...
    void HotspotsService::cpu(
            ::google::protobuf::RpcController *cntl_base,
            const ::melon::rpc::HotspotsRequest *,
            ::melon::rpc::HotspotsResponse *,
            ::google::protobuf::Closure *done) {
