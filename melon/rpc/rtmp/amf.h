...
#ifndef MELON_RPC_RTMP_AMF_H_
#define MELON_RPC_RTMP_AMF_H_
...
// A field inside a AMF object.
    ...
    public:
        ...
        bool IsString() const { return _type == AMF_MARKER_STRING || _type == AMF_MARKER_LONG_STRING; }

        bool IsBool() const { return _type == AMF_MARKER_BOOLEAN; }

        bool IsNumber() const { return _type == AMF_MARKER_NUMBER; }

        bool IsObject() const { return _type == AMF_MARKER_OBJECT || _type == AMF_MARKER_ECMA_ARRAY; }

        bool IsArray() const { return _type == AMF_MARKER_STRICT_ARRAY; }

        butil::StringPiece AsString() const { return butil::StringPiece((_is_shortstr ? _shortstr : _str), _strsize); }
