...
namespace melon::rpc {
    ...
    public:
        ...
        void allow_done_to_run_in_place() { add_flag(FLAGS_ALLOW_DONE_TO_RUN_IN_PLACE); }
    ...
    private:
        ...
        inline void set_flag(uint32_t f, bool t) { return t ? add_flag(f) : clear_flag(f); }
    ...
    // RPC calls. Example:
    //   stub1.method1(&cntl1, &request1, &response1, melon::rpc::DoNothing());
    //   stub2.method2(&cntl2, &request2, &response2, melon::rpc::DoNothing());
    //   ...
