...
// * melon::file_path::u8string() returns std::string instead of std::u8string
...
//- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// UTF8-Everywhere is the original behaviour of melon::filesystem. But since v1.5 the windows
...
// std::string as backend and for melon::file_path::native() and char for melon::file_path::c_str(). This
...
// [fs.class.directory_entry] Class directory_entry
        ...
        public:
            ...
            const melon::file_path &file_path() const noexcept;
...
// directory_entry::directory_entry(directory_entry&&) noexcept = default;
        ...
        GHC_INLINE directory_entry::directory_entry(const melon::file_path &p)
        ...
        GHC_INLINE directory_entry::directory_entry(const melon::file_path &p, std::error_code &ec)
                : _path(p), _file_size(static_cast<uintmax_t>(-1))
#ifndef GHC_OS_WINDOWS
                , _hard_link_count(static_cast<uintmax_t>(-1))
#endif
...
// [fs.dir.entry.mods] directory_entry modifiers
        ...
        GHC_INLINE void directory_entry::assign(const melon::file_path &p) {
            _path = p;
            refresh();
        }
        ...
        GHC_INLINE void directory_entry::assign(const melon::file_path &p, std::error_code &ec) {
            _path = p;
            refresh(ec);
        }
        ...
        GHC_INLINE void directory_entry::replace_filename(const melon::file_path &p) {
        ...
        GHC_INLINE void directory_entry::replace_filename(const melon::file_path &p, std::error_code &ec) {
            _path.replace_filename(p);
            refresh(ec);
        }
...
// [fs.dir.entry.obs] directory_entry observers
        GHC_INLINE const melon::file_path &directory_entry::file_path() const noexcept {
            return _path;
        }

        GHC_INLINE directory_entry::operator const melon::file_path &() const noexcept {
            return _path;
        }
