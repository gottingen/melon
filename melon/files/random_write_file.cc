...
namespace melon {
    ...
    result_status random_write_file::open(const melon::file_path &path, bool truncate) noexcept {
    ...
    result_status random_write_file::write(off_t offset, const melon::cord_buf &data) {
