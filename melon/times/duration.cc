 ...
 *****************************************************************/
// The implementation of the melon::duration class, which is declared in
// //melon/times/time.h.  This class behaves like a numeric type; it has no public
// methods and is used only through the operators defined here.
//
// Implementation notes:
//
// An melon::duration is represented as
//
...
//
    ...
    duration &duration::operator*=(double r) {
        if (is_infinite_duration() || !melon::base::is_finite(r)) {
