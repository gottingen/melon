...
#include "melon/times/internal/cycle_clock.h"
#include <atomic>
...
#ifdef NDEBUG
#ifdef MELON_INTERNAL_UNSCALED_CYCLECLOCK_FREQUENCY_IS_CPU_FREQUENCY
// Not debug mode and the unscaled_cycle_clock frequency is the CPU
// frequency.  Scale the melon::cycle_clock to prevent overflow if someone
