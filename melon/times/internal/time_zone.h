 ...
 *****************************************************************/
#ifndef MELON_TIMES_INTERNAL_TIME_ZONE_H_
#define MELON_TIMES_INTERNAL_TIME_ZONE_H_
...
namespace melon::times_internal {
    ...
    using sys_seconds = seconds;  // Deprecated.  Use melon::times_internal::seconds instead.

    namespace times_detail {
        template<typename D>
        MELON_FORCE_INLINE std::pair<time_point<seconds>, D>
        ...
        MELON_FORCE_INLINE std::pair<time_point<seconds>, seconds>
...
// melon::times_internal::time_zone is an opaque, small, value-type class representing a
...
//
// Example:
//   melon::times_internal::time_zone utc = melon::times_internal::utc_time_zone();
//   melon::times_internal::time_zone pst = melon::times_internal::fixed_time_zone(std::chrono::hours(-8));
//   melon::times_internal::time_zone loc = melon::times_internal::local_time_zone();
//   melon::times_internal::time_zone lax;
//   if (!melon::times_internal::load_time_zone("America/Los_Angeles", &lax)) { ... }
//
// See also:
...
// - https://en.wikipedia.org/wiki/Zoneinfo
    ...
    public:
        ...
        // An absolute_lookup represents the civil time (melon::times_internal::civil_second) within
        ...
        //   const melon::times_internal::time_zone::absolute_lookup al = tz.lookup(tp);
        struct absolute_lookup {
            ...
            // indirectly by way of melon::times_internal::format().
        ...
        // correspond to the given civil time (melon::times_internal::civil_second) within this
        ...
        //
        //   // A unique civil time.
        //   auto jan01 = lax.lookup(melon::times_internal::civil_second(2011, 1, 1, 0, 0, 0));
        //   // jan01.kind == melon::times_internal::time_zone::civil_lookup::UNIQUE
        //   // jan01.pre    is 2011/01/01 00:00:00 -0800
        //   // jan01.trans  is 2011/01/01 00:00:00 -0800
        //   // jan01.post   is 2011/01/01 00:00:00 -0800
        //
        //   // A Spring DST transition, when there is a gap in civil time.
        //   auto mar13 = lax.lookup(melon::times_internal::civil_second(2011, 3, 13, 2, 15, 0));
        //   // mar13.kind == melon::times_internal::time_zone::civil_lookup::SKIPPED
        //   // mar13.pre   is 2011/03/13 03:15:00 -0700
        //   // mar13.trans is 2011/03/13 03:00:00 -0700
        //   // mar13.post  is 2011/03/13 01:15:00 -0800
        //
        //   // A Fall DST transition, when civil times are repeated.
        //   auto nov06 = lax.lookup(melon::times_internal::civil_second(2011, 11, 6, 1, 15, 0));
        //   // nov06.kind == melon::times_internal::time_zone::civil_lookup::REPEATED
        ...
        //
        // Example:
        //   melon::times_internal::time_zone nyc;
        //   if (!melon::times_internal::load_time_zone("America/New_York", &nyc)) { ... }
        //   const auto now = std::chrono::system_clock::now();
        //   auto tp = melon::times_internal::time_point<melon::times_internal::seconds>::min();
        //   melon::times_internal::time_zone::civil_transition trans;
    ...
    // Returns the civil time (melon::times_internal::civil_second) within the given time zone at
    // the given absolute time (time_point). Since the additional fields provided
    // by the time_zone::absolute_lookup struct should rarely be needed in modern
    // code, this convert() function is simpler and should be preferred.
    template<typename D>
    MELON_FORCE_INLINE civil_second
    ...
    MELON_FORCE_INLINE time_point<seconds>
    ...
    // Formats the given time_point in the given melon::times_internal::time_zone according to
    ...
    //   melon::times_internal::time_zone lax;
    //   if (!melon::times_internal::load_time_zone("America/Los_Angeles", &lax)) { ... }
    //   auto tp = melon::times_internal::convert(melon::times_internal::civil_second(2013, 1, 2, 3, 4, 5), lax);
    //   std::string f = melon::times_internal::format("%H:%M:%S", tp, lax);  // "03:04:05"
    //   f = melon::times_internal::format("%H:%M:%E3S", tp, lax);            // "03:04:05.000"
    template<typename D>
    MELON_FORCE_INLINE std::string format(const std::string &fmt, const time_point<D> &tp,
           const time_zone &tz) {
    ...
    // options, with the same extensions as melon::times_internal::format(), but with the
    ...
    // than normalizing them like melon::times_internal::civil_second() would do. For example, it
    ...
    //   if (melon::times_internal::parse("%Y-%m-%d", "2015-10-09", tz, &tp)) {
    //     ...
    //   }
    template<typename D>
    MELON_FORCE_INLINE bool parse(const std::string &fmt, const std::string &input,
...
#endif  // MELON_TIMES_INTERNAL_TIME_ZONE_H_
