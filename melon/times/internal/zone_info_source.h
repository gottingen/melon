...
#ifndef MELON_TIMES_INTERNAL_ZONE_INFO_SOURCE_H_
#define MELON_TIMES_INTERNAL_ZONE_INFO_SOURCE_H_
...
namespace melon::times_internal {
    ...
    std::unique_ptr<melon::times_internal::zone_info_source> (*)(
            const std::string &,
            const std::function<std::unique_ptr<
                    melon::times_internal::zone_info_source>(const std::string &)> &);
    ...
    // melon::times_internal::load_time_zone() with:
    //
    //   namespace {
    //   std::unique_ptr<melon::times_internal::ZoneInfoSource> CustomFactory(
    //       const std::string& name,
    //       const std::function<std::unique_ptr<melon::times_internal::ZoneInfoSource>(
    ...
    //   (1) from the same thread as the melon::times_internal::load_time_zone() call,
...
#endif  // MELON_TIMES_INTERNAL_ZONE_INFO_SOURCE_H_
