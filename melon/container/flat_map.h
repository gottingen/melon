...
#ifndef MELON_CONTAINER_FLAT_MAP_H_
#define MELON_CONTAINER_FLAT_MAP_H_
...
#include "melon/container/single_threaded_pool.h"            // SingleThreadedPool
#include "melon/container/hash_tables.h"          // hash<>
#include "melon/container/bit_array.h"                       // bit_array_*
...
// Implement DefaultHasher and DefaultEqualTo
    template<typename K>
    struct DefaultHasher : public MELON_HASH_NAMESPACE::hash<K> {
    };
...
#include "melon/container/flat_map_inl.h"

#endif  // MELON_CONTAINER_FLAT_MAP_H_
