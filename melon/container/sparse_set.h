...
#ifndef  MELON_CONTAINER_SPARSE_SET_H_
#define MELON_CONTAINER_SPARSE_SET_H_
 ...
 * `melon::sh::exception_safety::strong`, the drawback is that the set will be
 ...
 private:
  ...
  using ht =
      detail_sparse_hash::sparse_hash<Key, KeySelect, void, Hash, KeyEqual,
                                      ...
                                      Sparsity, melon::sh::probing::quadratic>;
...
/**
 * Same as `melon::sparse_set<Key, Hash, KeyEqual, Allocator,
...
template <class Key, class Hash = std::hash<Key>,
          ...
          class Allocator = std::allocator<Key>>
using sparse_pg_set =
    sparse_set<Key, Hash, KeyEqual, Allocator, melon::sh::prime_growth_policy>;

}  // namespace melon

#endif  // MELON_CONTAINER_SPARSE_SET_H_
