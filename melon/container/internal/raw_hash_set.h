...
#ifndef MELON_CONTAINER_INTERNAL_RAW_HASH_SET_H_
#define MELON_CONTAINER_INTERNAL_RAW_HASH_SET_H_
        ...
        */
        ...
        public:
            ...
            int LowestBitSet() const {
                return melon::base::countr_zero(mask_) >> Shift;
            }

            int HighestBitSet() const {
                return (sizeof(T) * CHAR_BIT - melon::base::countl_zero(mask_) -
                        1) >>
                           Shift;
            }
            ...
            int leading_zeros() const {
                ...
                return melon::base::countl_zero(mask_ << extra_bits) >> Shift;
            }
...
#ifdef MELON_MAP_NON_DETERMINISTIC
...
// --------------------------------------------------------------------------
        ...
        struct group_portable_impl {
            ...
            explicit group_portable_impl(const ctrl_t *pos)
                    : ctrl(melon::little_endian::load64(pos)) {}
            ...
            uint32_t count_leading_empty_or_deleted() const {
                ...
                return (uint32_t) ((melon::base::countr_zero(((~ctrl & (ctrl >> 7)) | gaps) + 1) + 7) >> 3);
            }
            ...
            void convert_special_to_empty_and_full_to_deleted(ctrl_t *dst) const {
                ...
                auto x = ctrl & msbs;
                auto res = (~x + (x >> 7)) & ~lsbs;
                melon::little_endian::store64(dst, res);
            }
...
// --------------------------------------------------------------------------
        inline size_t NormalizeCapacity(size_t n) {
            return n ? ~size_t{} >> melon::base::countl_zero(n) : 1;
        }
...
// ----------------------------------------------------------------------------
        ...
        namespace memory_internal {
            ...
            void ConstructFromTupleImpl(Alloc *alloc, T *ptr, Tuple &&t,
                                        melon::index_sequence<I...>) {
                melon::allocator_traits<Alloc>::construct(
            ...
            decltype(std::declval<F>()(std::declval<T>())) WithConstructedImpl(
                    Tuple &&t, melon::index_sequence<Is...>, F &&f) {
                return WithConstructedImplF<T, F>{std::forward<F>(f)}(
                        std::get<Is>(std::forward<Tuple>(t))...);
            }

            template<class T, size_t... Is>
            auto TupleRefImpl(T &&t, melon::index_sequence<Is...>)
...
// ----------------------------------------------------------------------------
        ...
        public:
            ...
            using pointer = typename melon::allocator_traits<
                    allocator_type>::template rebind_traits<value_type>::pointer;
            using const_pointer = typename melon::allocator_traits<
        ...
        private:
            ...
            using Layout = melon::priv::Layout<ctrl_t, slot_type>;
            ...
            using AllocTraits = melon::allocator_traits<allocator_type>;
            using SlotAlloc = typename melon::allocator_traits<
                    allocator_type>::template rebind_alloc<slot_type>;
            using SlotAllocTraits = typename melon::allocator_traits<
            ...
            using RequiresInsertable = typename std::enable_if<
                    melon::disjunction<std::is_convertible<T, init_type>,
        ...
        public:
            ...
            public:
                ...
                using reference =
                melon::conditional_t<PolicyTraits::constant_iterators::value,
                        const value_type &, value_type &>;
                using pointer = melon::remove_reference_t<reference> *;
...
#if defined(MELON_BIDIRECTIONAL) && MELON_BIDIRECTIONAL
        ...
        iterator operator--(int) {
            ...
            //   // copies the strings into the set.
            //   melon::flat_hash_set<std::string> s = {"abc", "def"};
            //
            ...
            std::is_nothrow_copy_constructible<allocator_type>::value)
                    : ctrl_(melon::exchange(that.ctrl_, EmptyGroup())),
                      slots_(melon::exchange(that.slots_, nullptr)),
                      size_(melon::exchange(that.size_, 0)),
                      capacity_(melon::exchange(that.capacity_, 0)),
                      infoz_(melon::exchange(that.infoz_, HashtablezInfoHandle())),
            ...
            melon::allocator_traits<allocator_type>::is_always_equal::value &&
            ...
            template<class InputIt, typename melon::enable_if_t<has_difference_operator<InputIt>::value, int> = 0>
...
#if !defined(MELON_MAP_NON_DETERMINISTIC)

            template<typename OutputArchive>
            bool melon_map_dump(OutputArchive &) const;

            template<typename InputArchive>
            bool melon_map_load(InputArchive &);
        ...
        private:
            ...
            friend
            struct melon::priv::hashtable_debug_internal::HashtableDebugAccess;
            ...
            bool find_impl(const key_arg<K> &key, size_t hashval, size_t &offset) {
                ...
                while (true) {
                    ...
                    for (int i : g.match((h2_t) H2(hashval))) {
                        ...
                        if (MELON_LIKELY(PolicyTraits::apply(
                                EqualElement < K > {key, eq_ref()},
                                PolicyTraits::element(slots_ + offset))))
                            return true;
                    }
                    if (MELON_LIKELY(g.match_empty()))
                        return false;
                    seq.next();
                }
            }
            ...
            struct HashElement {
                ...
                size_t operator()(const K &key, Args &&...) const {
                    return melon_mix<sizeof(size_t)>()(h(key));
                }
            ...
            void drop_deletes_without_resize() MELON_NO_INLINE {
                ...
                for (size_t i = 0; i != capacity_; ++i) {
                    ...
                    if (MELON_LIKELY(probe_index(new_i) == probe_index(i))) {
            ...
            bool has_element(const value_type &elem, size_t hashval) const {
                ...
                while (true) {
                    Group g{ctrl_ + seq.offset()};
                    for (int i : g.match((h2_t) H2(hashval))) {
                        if (MELON_LIKELY(PolicyTraits::element(slots_ + seq.offset((size_t) i)) ==
                                         elem))
                            return true;
                    }
                    if (MELON_LIKELY(g.match_empty())) return false;
                    seq.next();
        ...
        protected:
            ...
            std::pair<size_t, bool> find_or_prepare_insert(const K &key, size_t hashval) {
                ...
                while (true) {
                    ...
                    if (MELON_LIKELY(g.match_empty())) break;
                    seq.next();
                }
            ...
            size_t prepare_insert(size_t hashval) MELON_NO_INLINE {
                auto target = find_first_non_full(hashval);
                if (MELON_UNLIKELY(growth_left() == 0 &&
        ...
        private:
            ...
            melon::priv::CompressedTuple<size_t /* growth_left */, hasher,
...
// --------------------------------------------------------------------------
        ...
        public:
            ...
            MappedReference<P> at(const key_arg<K> &key) {
                ...
                if (it == this->end())
                    melon::base_internal::ThrowStdOutOfRange("flat_hash_map at(): lookup non-existent key");
...
// ----------------------------------------------------------------------------
        ...
        protected:
            using Lockable = melon::LockableImpl<Mtx_>;
        ...
        public:
            ...
            explicit parallel_hash_set(size_t bucket_cnt,
                    ...
                    parallel_hash_set(typename Inner::Params{bucket_cnt, hash_param, eq, alloc},
                                      melon::make_index_sequence<num_tables>{}) {}

            template<std::size_t... i>
            parallel_hash_set(typename Inner::Params const &p,
                              melon::index_sequence<i...>) : sets_{((void) i, p)...} {}
        ...
        for (auto& inner : sets_)
            ...
            bool if_contains_unsafe(const key_arg<K> &key, F &&f) const {
                return const_cast<parallel_hash_set *>(this)->template
                        modify_if_impl<K, F, LockableBaseImpl<melon::null_mutex>::DoNothing>(key, std::forward<F>(f));
            }
            ...
            template<typename OutputArchive>
            bool melon_map_dump(OutputArchive &ar) const;

            template<typename InputArchive>
            bool melon_map_load(InputArchive &ar);
        ...
        struct flat_hash_set_policy {
            ...
            static void construct(Allocator *alloc, slot_type *slot, Args &&... args) {
                melon::allocator_traits<Allocator>::construct(*alloc, slot,
                                                              std::forward<Args>(args)...);
            }

            template<class Allocator>
            static void destroy(Allocator *alloc, slot_type *slot) {
                melon::allocator_traits<Allocator>::destroy(*alloc, slot);
            }
            ...
            template<class F, class... Args>
            static decltype(melon::priv::DecomposeValue(
                    std::declval<F>(), std::declval<Args>()...))
            apply(F &&f, Args &&... args) {
                return melon::priv::DecomposeValue(
        ...
        struct flat_hash_map_policy {
            ...
            template<class F, class... Args>
            static decltype(melon::priv::DecomposePair(
                    std::declval<F>(), std::declval<Args>()...))
            apply(F &&f, Args &&... args) {
                return melon::priv::DecomposePair(std::forward<F>(f),
                                                  std::forward<Args>(args)...);
            }
        ...
        struct node_hash_set_policy
                : melon::priv::node_hash_policy<T &, node_hash_set_policy<T>> {
            using key_type = T;
            using init_type = T;
            using constant_iterators = std::true_type;
            ...
            static T *new_element(Allocator *alloc, Args &&... args) {
                using ValueAlloc =
                typename melon::allocator_traits<Allocator>::template rebind_alloc<T>;
                ValueAlloc value_alloc(*alloc);
                T *res = melon::allocator_traits<ValueAlloc>::allocate(value_alloc, 1);
                melon::allocator_traits<ValueAlloc>::construct(value_alloc, res,
                                                               std::forward<Args>(args)...);
                return res;
            }
            ...
            static void delete_element(Allocator *alloc, T *elem) {
                ...
                typename melon::allocator_traits<Allocator>::template rebind_alloc<T>;
                ValueAlloc value_alloc(*alloc);
                melon::allocator_traits<ValueAlloc>::destroy(value_alloc, elem);
                melon::allocator_traits<ValueAlloc>::deallocate(value_alloc, elem, 1);
            }
...
// --------------------------------------------------------------------------
        ...
        class node_hash_map_policy
                : public melon::priv::node_hash_policy<
        ...
        public:
            ...
            static value_type *new_element(Allocator *alloc, Args &&... args) {
                using PairAlloc = typename melon::allocator_traits<
                        Allocator>::template rebind_alloc<value_type>;
                PairAlloc pair_alloc(*alloc);
                value_type *res =
                        melon::allocator_traits<PairAlloc>::allocate(pair_alloc, 1);
                melon::allocator_traits<PairAlloc>::construct(pair_alloc, res,
                                                              std::forward<Args>(args)...);
                return res;
            }
            ...
            static void delete_element(Allocator *alloc, value_type *pair) {
                using PairAlloc = typename melon::allocator_traits<
                        Allocator>::template rebind_alloc<value_type>;
                PairAlloc pair_alloc(*alloc);
                melon::allocator_traits<PairAlloc>::destroy(pair_alloc, pair);
                melon::allocator_traits<PairAlloc>::deallocate(pair_alloc, pair, 1);
            }
        ...
        struct hash_eq<T *> {
            struct hash {
                ...
                size_t operator()(const U &ptr) const {
                    return melon::hash<const T *>{}(hash_eq::ToPtr(ptr));
                }
            };
        ...
        namespace hashtable_debug_internal {
            ...
            struct HashtableDebugAccess<Set, melon::void_t<typename Set::raw_hash_set>> {
...
#endif  // MELON_CONTAINER_INTERNAL_RAW_HASH_SET_H_
