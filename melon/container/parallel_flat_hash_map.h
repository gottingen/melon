...
#ifndef MELON_CONTAINER_PARALLEL_FLAT_HASH_MAP_H_
#define MELON_CONTAINER_PARALLEL_FLAT_HASH_MAP_H_
...
namespace melon {
    ...
    // -----------------------------------------------------------------------------
    // melon::parallel_flat_hash_map - default values in map_fwd_decl.h
    // -----------------------------------------------------------------------------
    template<class K, class V, class Hash, class Eq, class Alloc, size_t N, class Mtx_>
    class parallel_flat_hash_map : public melon::priv::parallel_hash_map<
            N, melon::priv::raw_hash_set, Mtx_,
            melon::priv::flat_hash_map_policy<K, V>,
            Hash, Eq, Alloc> {
    ...
    template<class K, class V, class Hash, class Eq, class Alloc, size_t N, class Mtx_>
    class case_ignored_parallel_flat_hash_map : public melon::priv::parallel_hash_map<
            N, melon::priv::raw_hash_set, Mtx_,
            melon::priv::flat_hash_map_policy<K, V>,
            Hash, Eq, Alloc> {
...
#endif  // MELON_CONTAINER_PARALLEL_FLAT_HASH_MAP_H_
