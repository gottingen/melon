...
void TimerThread::run() {
    ...
    // vars
    size_t nscheduled = 0;
    melon::status_gauge<size_t> nscheduled_var(deref_value<size_t>, &nscheduled);
    melon::per_second<melon::status_gauge<size_t> > nscheduled_second(&nscheduled_var);
    size_t ntriggered = 0;
    melon::status_gauge<size_t> ntriggered_var(deref_value<size_t>, &ntriggered);
    melon::per_second<melon::status_gauge<size_t> > ntriggered_second(&ntriggered_var);
    double busy_seconds = 0;
    melon::status_gauge<double> busy_seconds_var(deref_value<double>, &busy_seconds);
    melon::per_second<melon::status_gauge<double> > busy_seconds_second(&busy_seconds_var);
...
}  // end namespace melon::fiber_internal
