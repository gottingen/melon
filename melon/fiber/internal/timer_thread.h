...
#ifndef MELON_FIBER_INTERNAL_TIMER_THREAD_H_
#define MELON_FIBER_INTERNAL_TIMER_THREAD_H_
...
private:
    ...
    internal::fast_pthread_mutex _mutex;    // protect _nearest_run_time
...
#endif  // MELON_FIBER_INTERNAL_TIMER_THREAD_H_
