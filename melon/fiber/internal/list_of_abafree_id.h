...
#ifndef MELON_FIBER_INTERNAL_LIST_OF_ABAFREE_ID_H_
#define MELON_FIBER_INTERNAL_LIST_OF_ABAFREE_ID_H_
...
// threads simultaneously. Think about the usage in melon::rpc::Socket, most
...
#endif  // MELON_FIBER_INTERNAL_LIST_OF_ABAFREE_ID_H_
