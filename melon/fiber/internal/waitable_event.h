...
#ifndef MELON_FIBER_INTERNAL_WAITABLE_EVENT_H_
#define MELON_FIBER_INTERNAL_WAITABLE_EVENT_H_

#include <errno.h>                               // users need to check errno
#include <time.h>                                // timespec
#include "melon/fiber/internal/types.h"                       // fiber_id_t
...
#endif  // MELON_FIBER_INTERNAL_WAITABLE_EVENT_H_
