...
#ifndef MELON_FIBER_FIBER_COND_H_
#define MELON_FIBER_FIBER_COND_H_

#include "melon/fiber/internal/fiber_cond.h"
...
namespace melon {
    ...
    public:
        ...
        void wait(std::unique_lock<melon::fiber_mutex> &lock) {
...
#endif // MELON_FIBER_FIBER_COND_H_
