...
//adding primitive types
    ...
    void Serializer::add_int8(int8_t value) { add_primitive(_stream, peek_group_info(), value); }

    void Serializer::add_int16(int16_t value) { add_primitive(_stream, peek_group_info(), value); }

    void Serializer::add_int32(int32_t value) { add_primitive(_stream, peek_group_info(), value); }

    void Serializer::add_int64(int64_t value) { add_primitive(_stream, peek_group_info(), value); }

    void Serializer::add_uint8(uint8_t value) { add_primitive(_stream, peek_group_info(), value); }

    void Serializer::add_uint16(uint16_t value) { add_primitive(_stream, peek_group_info(), value); }

    void Serializer::add_uint32(uint32_t value) { add_primitive(_stream, peek_group_info(), value); }

    void Serializer::add_uint64(uint64_t value) { add_primitive(_stream, peek_group_info(), value); }

    void Serializer::add_bool(bool value) { add_primitive(_stream, peek_group_info(), value); }

    void Serializer::add_float(float value) { add_primitive(_stream, peek_group_info(), value); }

    void Serializer::add_double(double value) { add_primitive(_stream, peek_group_info(), value); }
...
// append string/raw
    ...
    void Serializer::add_string(const StringWrapper &name, const StringWrapper &s) {
        add_binary_internal(_stream, peek_group_info(), name,
                            std::string_view(s.data(), s.size() + 1), FIELD_STRING);
    }
    ...
    void Serializer::add_binary(const StringWrapper &name,
        ...
        add_binary_internal(_stream, peek_group_info(), name,
                            std::string_view((const char *) data, n), FIELD_BINARY);
    }
