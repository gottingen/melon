...
namespace melon::raft {
    ...
    static melon::var::PerSecond<melon::var::Adder<int64_t> > g_read_entry_from_storage_second
            ("raft_read_entry_from_storage_second", &g_read_entry_from_storage);

    static melon::var::Adder<int64_t> g_read_term_from_storage
            ("raft_read_term_from_storage_count");
    static melon::var::PerSecond<melon::var::Adder<int64_t> > g_read_term_from_storage_second
            ("raft_read_term_from_storage_second", &g_read_term_from_storage);

    static melon::var::LatencyRecorder g_storage_append_entries_latency(
            "raft_storage_append_entries");
    static melon::var::LatencyRecorder g_nomralized_append_entries_latency(
            "raft_storage_append_entries_normalized");
    static melon::var::Adder<int64_t> g_storage_append_entries_concurrency(
            "raft_storage_append_entries_concurrency");

    static melon::var::CounterRecorder g_storage_flush_batch_counter(
