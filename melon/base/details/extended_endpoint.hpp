...
#ifndef MUTIL_DETAILS_EXTENDED_ENDPOINT_H
#define MUTIL_DETAILS_EXTENDED_ENDPOINT_H
    ...
    namespace details {
        ...
        public:
            ...
            static GlobalEndPointSet *instance() {
                return ::mutil::get_leaky_singleton<GlobalEndPointSet>();
            }
        ...
        public:
            ...
            static bool is_extended(const mutil::EndPoint &ep) {
        ...
        private:
            ...
            static ExtendedEndPoint *new_extended_endpoint(sa_family_t family) {
                ...
                if (eep) {
                    ...
                    CHECK(eep->_u.sa.sa_family == AF_UNSPEC) << "new ExtendedEndPoint has family "
                                                             << eep->_u.sa.sa_family << " set";
        ...
        inline bool
        GlobalEndPointSet::Equals::operator()(ExtendedEndPoint *const &p1, ExtendedEndPoint *const &p2) const {
...
#endif // MUTIL_DETAILS_EXTENDED_ENDPOINT_H
