...
#ifndef MELON_BASE_MATH_BIT_ITERATOR_H_
#define MELON_BASE_MATH_BIT_ITERATOR_H_

#include <bitset>
#include <limits>
#include "melon/base/profile.h"
#include "melon/base/math/countl_zero.h"
#include "melon/base/math/countr_zero.h"
...
namespace melon::base {
     ...
     */
    template<size_t N>
    static MELON_FORCE_INLINE size_t get_first_set(const std::bitset<N> &bitset) {
     ...
     */
    template<size_t N>
    static MELON_FORCE_INLINE size_t get_last_set(const std::bitset<N> &bitset) {
        static_assert(N <= ulong_bits, "bitset too large");
    ...
    template<size_t N>
    MELON_FORCE_INLINE set_range<N> for_each_set(std::bitset<N> bitset, int offset = 0) {
        return set_range<N>(bitset, offset);
    }

}  // namespace melon::base

#endif  // MELON_BASE_MATH_BIT_ITERATOR_H_
