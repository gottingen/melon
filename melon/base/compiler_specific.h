...
#ifndef MUTIL_FORCE_INLINE
#if defined(COMPILER_MSVC)
#define MUTIL_FORCE_INLINE    __forceinline
#else
#define MUTIL_FORCE_INLINE inline __attribute__((always_inline))
#endif
#endif  // MUTIL_FORCE_INLINE
...
#    define MELON_LIKELY(expr) (__builtin_expect((bool)(expr), true))
#    define MELON_UNLIKELY(expr) (__builtin_expect((bool)(expr), false))
#  else
...
// Cacheline related --------------------------------------
#define MELON_CACHELINE_SIZE 64

#define MELON_CACHELINE_ALIGNMENT ALIGNAS(MELON_CACHELINE_SIZE)

#ifndef MELON_NOEXCEPT
# if defined(MUTIL_CXX11_ENABLED)
#  define MELON_NOEXCEPT noexcept
# else
#  define MELON_NOEXCEPT
# endif
#endif

#endif  // MUTIL_COMPILER_SPECIFIC_H_
