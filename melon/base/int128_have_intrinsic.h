...
// representation when MELON_HAVE_INTRINSIC_INT128 is defined. This file is
// included by int128.h and relies on MELON_INTERNAL_WCHAR_T being defined.
...
MELON_FORCE_INLINE int128 &int128::operator=(__int128 v) {
    v_ = v;
    return *this;
}
...
MELON_FORCE_INLINE int128::int128(float v) {
    v_ = static_cast<__int128>(v);
}

MELON_FORCE_INLINE int128::int128(double v) {
    v_ = static_cast<__int128>(v);
}

MELON_FORCE_INLINE int128::int128(long double v) {
    v_ = static_cast<__int128>(v);
}
...
constexpr int128::operator MELON_INTERNAL_WCHAR_T() const {
    return static_cast<MELON_INTERNAL_WCHAR_T>(v_);
}
...
MELON_FORCE_INLINE int128::operator float() const { return static_cast<float>(v_); }

MELON_FORCE_INLINE int128::operator double() const { return static_cast<double>(v_); }

MELON_FORCE_INLINE int128::operator long double() const {
...
MELON_FORCE_INLINE int128::operator float() const {
...
MELON_FORCE_INLINE int128::operator double() const {
...
MELON_FORCE_INLINE bool operator==(int128 lhs, int128 rhs) {
...
MELON_FORCE_INLINE int128
operator-(int128 v) {
    return -static_cast<__int128>(v);
}

MELON_FORCE_INLINE bool operator!(int128 v) {
    return !static_cast<__int128>(v);
}

MELON_FORCE_INLINE int128 operator~(int128 val) {
    return ~static_cast<__int128>(val);
}

// Arithmetic operators.

MELON_FORCE_INLINE int128 operator+(int128 lhs, int128 rhs) {
    return static_cast<__int128>(lhs) + static_cast<__int128>(rhs);
}
...
MELON_FORCE_INLINE int128 int128::operator++(int) {
    int128 tmp(*this);
    ++v_;
    return tmp;
}
...
MELON_FORCE_INLINE int128 &int128::operator++() {
    ++v_;
    return *this;
}
...
MELON_FORCE_INLINE int128 operator<<(int128 lhs, int amount) {
