...
macro(carbin_find_static_leveldb)
    ...
    carbin_print("LEVELDB_STATIC_FOUND: ${LEVELDB_STATIC_FOUND}")
    if (LEVELDB_STATIC_FOUND)
        carbin_print("LEVELDB_INCLUDE_PATH: ${LEVELDB_INCLUDE_DIR}")
...
macro(carbin_find_static_gflags)
    ...
    carbin_print("GFLAGS_STATIC_FOUND: ${GFLAGS_STATIC_FOUND}")
    if (GFLAGS_STATIC_FOUND)
        carbin_print("GFLAGS_INCLUDE_PATH: ${GFLAGS_INCLUDE_DIR}")
...
# snappy
##################################
macro(carbin_find_static_snappy)
    ...
    carbin_print("SNAPPY_STATIC_FOUND: ${SNAPPY_STATIC_FOUND}")
    if (SNAPPY_STATIC_FOUND)
        carbin_print("SNAPPY_INCLUDE_PATH: ${SNAPPY_INCLUDE_DIR}")
        carbin_print("SNAPPY_STATIC_LIB: ${SNAPPY_STATIC_LIB}")
    endif ()
endmacro()
...
macro(carbin_find_static_zlib)
    ...
    find_path(ZLIB_INCLUDE_DIR NAMES zlib.h PATHS ${EA_ROOT})
    find_library(ZLIB_STATIC_LIB NAMES libz.a PATHS ${EA_ROOT})
    if (ZLIB_STATIC_LIB AND ZLIB_INCLUDE_DIR)
        set(ZLIB_STATIC_FOUND TRUE)
    endif ()
    carbin_print("ZLIB_FOUND: ${ZLIB_STATIC_FOUND}")
    if (ZLIB_FOUND)
